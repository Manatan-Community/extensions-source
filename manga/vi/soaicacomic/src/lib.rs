...
const SOURCE: SoaiCaComic = SoaiCaComic;
const BASE_URL: &str = "https://soaicacomic2.top";

struct SoaiCaComic;

impl MangaSource for SoaiCaComic {
    ...
    fn handle_url(&self, request: Value) -> ExtensionResult<Option<UrlResolveResult>> {
        ...
        if let Some(key) = key_from_url(input) {
            let is_manga = key.contains("/truyen-tranh/") && !key.contains("-chap-");
...
const HOME_FIXTURE: &str = r#"<div id="day-charts"><div class="sidebar-comic-block"><a class="sidebar-comic-block-link" href="/truyen-tranh/sample"><h3 class="sidebar-comic-block-title">Sample</h3><img src="/cover.jpg"></a></div></div>"#;
const LIST_FIXTURE: &str = r#"<div class="comic-list-item"><a class="comic-block-link" href="/truyen-tranh/sample"><div class="comic-block-img"><img src="/cover.jpg"></div><h3 class="comic-block-title">Sample</h3></a></div>"#;
const SEARCH_FIXTURE: &str = r#"{"success":true,"data":[{"title":"Sample","link":"https://soaicacomic2.top/truyen-tranh/sample","img":"/cover-150x150.jpg"}]}"#;
const DETAILS_FIXTURE: &str = r#"<h2 class="comic-title">Sample</h2><div class="comic-desc-list"><meta itemprop="image" content="/cover.jpg"><ul><li><strong>Tác giả</strong> Author</li></ul></div><span class="comic-stt">Đang tiến hành</span><div class="hide-long-text"><p>Summary</p></div><div class="chapter-list"><div class="chapter-item"><a class="chapter-link" href="/truyen-tranh/sample-chap-1"><p class="chapter-title">Chap 1</p><p class="chapter-meta">01/01/2024</p></a></div></div>"#;
