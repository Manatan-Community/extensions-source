...
const SOURCE: SayHentai = SayHentai;
const BASE_URL: &str = "https://sayhentai.sh";

struct SayHentai;

impl MangaSource for SayHentai {
...
const SEARCH_FIXTURE: &str = r#"{"success":true,"data":[{"title":"Sample","link":"https://sayhentai.sh/truyen/sample","img":"/cover-150x150.jpg"}]}"#;
