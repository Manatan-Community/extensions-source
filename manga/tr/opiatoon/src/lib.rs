...
const SOURCE: Opiatoon = Opiatoon;
struct Opiatoon;

impl manga::MadaraSource for Opiatoon {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig { base_url: "https://opiatoon.lat", lang: "tr", content_rating: "adult", manga_path: "manga", popular_url_marker: "post-title", use_load_more: false, latest_enabled: true }
    }
