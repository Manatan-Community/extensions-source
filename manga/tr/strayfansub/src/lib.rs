...
const SOURCE: StrayFansub = StrayFansub;
struct StrayFansub;

impl manga::MadaraSource for StrayFansub {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig { base_url: "https://strayfansub.net", lang: "tr", content_rating: "adult", manga_path: "manga", popular_url_marker: "post-title", use_load_more: false, latest_enabled: true }
    }
...
impl_madara_source!(StrayFansub);
