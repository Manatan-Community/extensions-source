...
const SOURCE: RuyaMangaNet = RuyaMangaNet;
struct RuyaMangaNet;

impl manga::MadaraSource for RuyaMangaNet {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig { base_url: "https://ruyamanga.net", lang: "tr", content_rating: "safe", manga_path: "manga", popular_url_marker: "post-title", use_load_more: false, latest_enabled: true }
    }
...
impl_madara_source!(RuyaMangaNet);
