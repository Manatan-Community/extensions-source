...
const SOURCE: Yaoibar = Yaoibar;
struct Yaoibar;

impl manga::MadaraSource for Yaoibar {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig { base_url: "https://yaoibar.lol", lang: "tr", content_rating: "adult", manga_path: "manga", popular_url_marker: "post-title", use_load_more: false, latest_enabled: true }
    }
