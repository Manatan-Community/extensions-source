...
const SOURCE: Hayalistic = Hayalistic;

struct Hayalistic;

impl manga::MadaraSource for Hayalistic {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig {
            base_url: "https://hayalistic.blog",
            lang: "tr",
            content_rating: "safe",
            manga_path: "manga",
...
impl_madara_source!(Hayalistic);
export_manga_source!(SOURCE);

const LIST_FIXTURE: &str = r#"
<div class="page-item-detail">
  <h3 class="post-title"><a href="/manga/sample/">Sample Hayalistic</a></h3>
  <img src="/cover.jpg">
</div>
...
<h1 class="post-title">Sample Hayalistic</h1>
<div class="summary_image"><img src="/cover.jpg"></div>
<div class="description-summary">Sample description.</div>
<ul><li class="wp-manga-chapter"><a href="/manga/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">01/01/2024</span></li></ul>
"#;
