...
const SOURCE: MangaSehriNet = MangaSehriNet;

struct MangaSehriNet;

impl manga::MadaraSource for MangaSehriNet {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig {
            base_url: "https://manga-sehri.net",
            lang: "tr",
...
impl_madara_source!(MangaSehriNet);
