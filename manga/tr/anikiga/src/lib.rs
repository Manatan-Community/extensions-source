...
const SOURCE: Anikiga = Anikiga;

struct Anikiga;

impl manga::MadaraSource for Anikiga {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig { base_url: "https://anikiga.com", lang: "tr", content_rating: "safe", manga_path: "manga", popular_url_marker: "post-title", use_load_more: false, latest_enabled: true }
    }
