...
const SOURCE: TortugaCeviri = TortugaCeviri;
struct TortugaCeviri;

impl manga::MadaraSource for TortugaCeviri {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig { base_url: "https://tortugaceviri.com", lang: "tr", content_rating: "safe", manga_path: "manga", popular_url_marker: "post-title", use_load_more: false, latest_enabled: true }
    }
...
impl_madara_source!(TortugaCeviri);
