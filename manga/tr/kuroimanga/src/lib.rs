...
const SOURCE: KuroiManga = KuroiManga;
const BASE_URL: &str = "https://www.kuroimanga.mom";
const LOGIN_REQUIRED: &str = "Subscribe in WebView to read this chapter";
...
impl MangaSource for KuroiManga {
...
<div class="page-item-detail">
  <h3 class="post-title"><a href="/manga/sample/">Sample Kuroi Manga</a></h3>
  <img src="/cover.jpg">
</div>
...
<h1 class="post-title">Sample Kuroi Manga</h1>
...
mod tests {
    ...
    #[test]
    fn detects_blocked_pages() {
        assert!(is_blocked(r#"<div class="login-required"></div>"#));
    }
}
