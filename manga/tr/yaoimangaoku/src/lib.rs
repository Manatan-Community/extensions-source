...
const SOURCE: YaoiMangaOku = YaoiMangaOku;
struct YaoiMangaOku;

impl manga::MadaraSource for YaoiMangaOku {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig { base_url: "https://yaoimangaoku.net", lang: "tr", content_rating: "adult", manga_path: "manga", popular_url_marker: "post-title", use_load_more: false, latest_enabled: true }
    }
...
impl_madara_source!(YaoiMangaOku);
