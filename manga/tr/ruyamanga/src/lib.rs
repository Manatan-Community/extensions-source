...
const SOURCE: RuyaManga = RuyaManga;
struct RuyaManga;

impl manga::MadaraSource for RuyaManga {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig { base_url: "https://www.ruyamanga2.com", lang: "tr", content_rating: "safe", manga_path: "manga", popular_url_marker: "post-title", use_load_more: false, latest_enabled: true }
    }
