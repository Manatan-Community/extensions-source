...
const SOURCE: SummerToon = SummerToon;
struct SummerToon;

impl manga::MadaraSource for SummerToon {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig { base_url: "https://summertoons.net", lang: "tr", content_rating: "safe", manga_path: "manga", popular_url_marker: "post-title", use_load_more: false, latest_enabled: true }
    }
