...
const SOURCE: GarciaManga = GarciaManga;
const BASE_URL: &str = "https://garciamanga.com";
...
impl MangaSource for GarciaManga {
...
<div class="page-item-detail">
  <h3 class="post-title"><a href="/manga/sample/">Sample Garcia Manga</a></h3>
  <img src="/cover.jpg">
</div>
...
<h1 class="post-title">Sample Garcia Manga</h1>
<div class="summary_image"><img src="/cover.jpg"></div>
<div class="description-summary">Sample description.</div>
<ul><li class="wp-manga-chapter"><a href="/manga/sample/chapter-1/">Bolum 1</a><span class="chapter-release-date">Ocak 1, 2024</span></li></ul>
"#;
