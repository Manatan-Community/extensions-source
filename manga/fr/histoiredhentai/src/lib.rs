...
const SOURCE: HistoireDHentai = HistoireDHentai;
const CONFIG: MadaraConfig = MadaraConfig {
    base_url: "https://hhentai.fr",
    lang: "fr",
...
struct HistoireDHentai;

impl MangaSource for HistoireDHentai {
...
<div class="page-item-detail"><h3 class="post-title"><a href="/manga/sample/">Sample Histoire</a></h3><img src="/cover.jpg"></div>
<div class="nav-previous"></div>
"#;
const DETAILS_FIXTURE: &str = r#"
<h1 class="post-title">Sample Histoire</h1><div class="summary_image"><img src="/cover.jpg"></div><div class="description-summary">Resume</div>
<ul><li class="wp-manga-chapter"><a href="/manga/sample/chapter-1/">Chapitre 1</a><span class="chapter-release-date">2024-01-01</span></li></ul>
"#;
