...
const SOURCE: MangasOriginesFr = MangasOriginesFr;
const CONFIG: MadaraConfig = MadaraConfig {
    base_url: "https://mangas-origines.fr",
    lang: "fr",
    content_rating: "safe",
    manga_path: "catalogues",
    popular_url_marker: "post-title",
    use_load_more: false,
    latest_enabled: true,
};

struct MangasOriginesFr;

impl MangaSource for MangasOriginesFr {
    ...
    fn details(&self, request: Value) -> ExtensionResult<CatalogItem> {
        let key =
            manga::request_key(&request, "manga").unwrap_or_else(|| "/catalogues/sample".into());
        let body =
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        let key = manga::request_key(&request, "chapter")
            .unwrap_or_else(|| "/catalogues/sample/chapter-1".into());
        let body =
...
fn deeplink_key(input: &str) -> Option<String> {
    if input.starts_with(CONFIG.base_url) && input.contains("/catalogues/") {
...
<div class="page-item-detail"><div class="item-thumb"><a href="https://mangas-origines.fr/catalogues/sample/"><img src="/cover.jpg"></a></div><div class="post-title"><h3><a href="https://mangas-origines.fr/catalogues/sample/">Sample</a></h3></div></div>
<div class="nav-previous"><a href="/catalogues/page/2/?m_orderby=views">Next</a></div>
"#;
...
<ul><li class="wp-manga-chapter"><a href="https://mangas-origines.fr/catalogues/sample/chapter-1/">Chapitre 1</a><span class="chapter-release-date">2024-01-01</span></li></ul>
"#;
