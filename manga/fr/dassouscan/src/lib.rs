...
const SOURCE: DassouScan = DassouScan;
const CONFIG: MadaraConfig = MadaraConfig {
    base_url: "https://dassouscan.com",
    lang: "fr",
    content_rating: "safe",
    manga_path: "manga",
...
impl MangaSource for DassouScan {
...
<div class="page-item-detail"><div class="item-thumb"><a href="https://dassouscan.com/manga/sample/"><img src="/cover.jpg"></a></div><div class="post-title"><h3><a href="https://dassouscan.com/manga/sample/">Sample</a></h3></div></div>
...
<ul><li class="wp-manga-chapter"><a href="https://dassouscan.com/manga/sample/chapter-1/">Chapitre 1</a><span class="chapter-release-date">2024-01-01</span></li></ul>
"#;
