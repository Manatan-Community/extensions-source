...
const SOURCE: ScanReader = ScanReader;
const BASE_URL: &str = "https://scanreader.net";

struct ScanReader;

impl MangaSource for ScanReader {
    ...
    body.split("<a")
        ...
        .filter_map(|chunk| {
            ...
            Some(MangaChapter {
                key: key.clone(),
                title,
                date_uploaded: dates::parse_fixture_date(&date_text),
...
<div class="popular-section"><div class="manga-card"><a href="https://scanreader.net/manga/sample" onclick="addToHistory(1,'Sample','/cover.jpg')"><img data-lazy-src="/cover.jpg"></a><h3>Sample</h3></div></div>
<a class="pagination-next" href="/bibliotheque/page/1/"></a>
"#;
const LATEST_FIXTURE: &str = r#"
<div class="manga-cover"><a href="https://scanreader.net/manga/sample"><img data-lazy-src="/cover.jpg"></a><h3 class="manga-title-display">Sample</h3></div>
"#;
...
const CHAPTERS_FIXTURE: &str =
    r#"{"data":"<a href=\"/chapitre/sample-1\"><h4>Chapitre 1</h4><span>01/01/2024</span></a>"}"#;
const PAGES_FIXTURE: &str = r#"<script>const pages=["gpj.1egap/ten.redaernacs//:sptth"];</script>"#;
