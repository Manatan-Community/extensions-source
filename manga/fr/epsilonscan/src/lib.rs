...
const SOURCE: EpsilonScan = EpsilonScan;
const CONFIG: MadaraConfig = MadaraConfig {
    base_url: "https://epsilonscan.to",
    lang: "fr",
...
impl MangaSource for EpsilonScan {
...
<div class="page-item-detail"><div class="item-thumb"><a href="https://epsilonscan.to/manga/sample/"><img src="/cover.jpg"></a></div><div class="post-title"><h3><a href="https://epsilonscan.to/manga/sample/">Sample</a></h3></div></div>
"#;
...
<ul><li class="wp-manga-chapter"><a href="https://epsilonscan.to/manga/sample/chapter-1/">Chapitre 1</a><span class="chapter-release-date">2024-01-01</span></li></ul>
"#;
