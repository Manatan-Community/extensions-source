...
const SOURCE: KodokuStudio = KodokuStudio;
const CONFIG: manga::MadaraConfig = manga::MadaraConfig {
    base_url: "https://kodokustudio.com",
    lang: "all",
    content_rating: "safe",
    manga_path: "manhua",
...
impl MangaSource for KodokuStudio {
    ...
    fn search(&self, request: Value) -> ExtensionResult<Paged<CatalogItem>> {
        ...
        let query = request
            ...
            .unwrap_or_default()
            .trim();
        if query.starts_with(CONFIG.base_url) && query.contains("/manhua/") {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        let key =
            manga::request_key(&request, "chapter").unwrap_or_else(|| "/manhua/sample/chapter-1".into());
    ...
    fn handle_url(&self, request: Value) -> ExtensionResult<Option<UrlResolveResult>> {
        ...
        if input.starts_with(CONFIG.base_url) && input.contains("/manhua/") {
...
<div class="page-item-detail manga"><a href="https://kodokustudio.com/manhua/sample/">Sample</a><img src="https://kodokustudio.com/cover.jpg"></div>
<div class="nav-previous"><a href="/manhua/page/2/">Next</a></div>
"#;

const DETAILS_FIXTURE: &str = r#"
<h1>Sample</h1>
<div class="summary_image"><img src="https://kodokustudio.com/cover.jpg"></div>
<li class="wp-manga-chapter"><a href="https://kodokustudio.com/manhua/sample/chapter-1/">Open</a><a>Readable Chapter Name</a><span class="chapter-release-date">2024-01-01</span></li>
"#;

const PAGES_FIXTURE: &str = r#"
<div class="reading-content"><img class="wp-manga-chapter-img" src="https://kodokustudio.com/page-1.jpg"></div>
"#;
...
mod tests {
    ...
    #[test]
    fn parses_kodoku_studio_madara_source() {
        assert_eq!(manga::Madara::parse_listing(LIST_FIXTURE, &CONFIG).len(), 1);
        let chapters = parse_chapters(DETAILS_FIXTURE, "/manhua/sample");
