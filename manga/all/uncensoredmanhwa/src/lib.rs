...
const SOURCE: UncensoredManhwa = UncensoredManhwa;
const CONFIG: manga::MadaraConfig = manga::MadaraConfig {
    base_url: "https://uncensoredmanhwa.us",
    lang: "all",
...
struct UncensoredManhwa;

impl MangaSource for UncensoredManhwa {
...
fn source_for(request: &Value) -> SourceKind {
    match request
        ...
        .and_then(Value::as_str)
    {
        Some("uncensoredmanhwa-all") => SourceKind::All,
        _ => SourceKind::En,
    }
}
...
<div class="page-item-detail manga"><a href="https://uncensoredmanhwa.us/manga/sample" title="Sample Manhwa">Sample Manhwa</a><img data-src="/cover.jpg"></div>
<div class="page-item-detail manga"><a href="https://uncensoredmanhwa.us/manga/sample-raw" title="Sample Raw">Sample Raw</a><img data-src="/raw.jpg"></div>
<div class="nav-previous"><a href="/manga/page/2">Next</a></div>
"#;

const DETAILS_FIXTURE: &str = r#"
<div class="post-title"><h1>Sample Manhwa</h1></div>
<div class="summary_image"><img src="/cover.jpg"></div>
<div class="summary__content">Adult sample.</div>
<li class="wp-manga-chapter"><a href="https://uncensoredmanhwa.us/manga/sample/chapter-1">Chapter 1</a><span class="chapter-release-date">January 1, 2024</span></li>
"#;
...
mod tests {
    ...
    #[test]
    fn filters_raw_entries_for_english_source() {
        let entries = manga::Madara::parse_listing(LIST_FIXTURE, &CONFIG);
        assert_eq!(filter_source(entries.clone(), SourceKind::All).len(), 2);
        let english = filter_source(entries, SourceKind::En);
        assert_eq!(english.len(), 1);
        assert_eq!(english[0].language.as_deref(), Some("en"));
    }
