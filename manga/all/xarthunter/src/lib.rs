...
const SOURCE: XArtHunter = XArtHunter;
const CONFIG: manga::MasonryConfig = manga::MasonryConfig {
    base_url: "https://www.xarthunter.com",
    name: "XArt Hunter",
    lang: "all",
...
impl manga::MasonrySource for XArtHunter {
...
impl_masonry_source!(XArtHunter);

export_manga_source!(SOURCE);

const LIST_FIXTURE: &str = r#"
<figure class="list-gallery"><a href="https://www.xarthunter.com/gallery/sample/" title="Sample Gallery"><img src="/thumb.jpg"></a></figure>
...
<div class="list-gallery"><a href="https://cdn.xarthunter.com/images/1.jpg">1</a><a href="https://cdn.xarthunter.com/images/2.jpg">2</a></div>
"#;
