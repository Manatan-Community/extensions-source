...
const SOURCE: ImHentai = ImHentai;

const CONFIGS: [manga::GalleryAdultsConfig; 8] = [
    config("imhentai-en", "en", "english"),
    config("imhentai-ja", "ja", "japanese"),
    config("imhentai-es", "es", "spanish"),
    config("imhentai-fr", "fr", "french"),
    config("imhentai-ko", "ko", "korean"),
    config("imhentai-de", "de", "german"),
    config("imhentai-ru", "ru", "russian"),
    config("imhentai-all", "all", ""),
];
...
impl manga::GalleryAdultsSource for ImHentai {
...
impl_gallery_adults_source!(ImHentai);

fn config_for(request: &Value) -> &'static manga::GalleryAdultsConfig {
    let source_id = manga::GalleryAdults::source_id(request, "imhentai-all");
    CONFIGS
        .iter()
...
<div class="gallery"><a href="https://imhentai.xxx/gallery/123/"><img class="gthumb" src="https://img.example/123t.jpg" alt="Fixture Gallery"></a><div class="gallery_title">Fixture Gallery</div><a><span class="thumb_flag"></span></a></div>
...
<li><span class="tags_text">Tags:</span><a class="tag">Action</a><a class="tag">Drama</a></li>
<li><span class="tags_text">Artists:</span><a class="tag">Artist One</a></li>
<li><span class="tags_text">Groups:</span><a class="tag">Group One</a></li>
"#;
