...
const SOURCE: EliteBabes = EliteBabes;
...
impl manga::MasonrySource for EliteBabes {
...
impl_masonry_source!(EliteBabes);

export_manga_source!(SOURCE);

const LIST_FIXTURE: &str = r#"
<figure class="list-gallery"><a href="https://www.elitebabes.com/gallery/sample/" title="Sample Gallery"><img src="https://cdn.elitebabes.com/thumb.jpg"></a></figure>
...
<div class="list-gallery"><a href="https://cdn.elitebabes.com/images/1.jpg">1</a><a href="https://cdn.elitebabes.com/images/2.jpg">2</a></div>
"#;
...
mod tests {
    ...
    fn parses_masonry_source() {
        ...
        assert_eq!(manga::Masonry::parse_details(DETAILS_FIXTURE, Some("/gallery/sample".into()), &CONFIG).title, "Sample Gallery");
