...
const SOURCE: FtvHunter = FtvHunter;
const CONFIG: manga::MasonryConfig = manga::MasonryConfig {
    base_url: "https://www.ftvhunter.com",
    name: "FTV Hunter",
    lang: "all",
...
impl manga::MasonrySource for FtvHunter {
...
impl_masonry_source!(FtvHunter);

export_manga_source!(SOURCE);

const LIST_FIXTURE: &str = r#"
<figure class="list-gallery"><a href="https://www.ftvhunter.com/gallery/sample/" title="Sample Gallery"><img src="https://cdn.ftvhunter.com/thumb.jpg"></a></figure>
...
<div class="list-gallery"><a href="https://cdn.ftvhunter.com/images/1.jpg">1</a><a href="https://cdn.ftvhunter.com/images/2.jpg">2</a></div>
"#;
