...
const SOURCE: EighteenManhua = EighteenManhua;
const BASE_URL: &str = "https://18mh.org";

struct EighteenManhua;

impl MangaSource for EighteenManhua {
...
fn parse_listing(body: &str) -> Paged<CatalogItem> {
    Paged {
        ...
        has_next_page: body.contains("aria-label=\"NEXT\"") || body.contains("aria-label=下一頁"),
    }
}
...
fn parse_card(chunk: &str) -> Option<CatalogItem> {
    ...
    Some(CatalogItem {
        ...
        title: html::text_between(chunk, "<h3", "</h3>")
            ...
            .unwrap_or_else(|| url::slug_from_url(&key).unwrap_or_else(|| "18漫画".into())),
        cover: image,
...
<div class="container"><div class="cardlist"><div class="pb-2"><a href="/manga/sample"><img src="/cover.jpg"><h3>Sample Manga</h3></a></div></div></div><a aria-label="下一頁"><button>Next</button></a>
"#;
