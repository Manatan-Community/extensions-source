...
const SOURCE: TuttoAnimeManga = TuttoAnimeManga;

struct TuttoAnimeManga;

impl PizzaReaderSource for TuttoAnimeManga {
    fn pizza_config(&self) -> PizzaReaderConfig {
        PizzaReaderConfig {
            base_url: "https://tuttoanimemanga.net",
...
impl_pizza_reader_source!(TuttoAnimeManga);
