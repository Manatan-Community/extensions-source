...
const SOURCE: Zenon = Zenon;
const BASE_URL: &str = "https://comic-zenon.com";
const SOURCE_NAME: &str = "Zenon";
const DEFAULT_COLLECTION: &str = "zenyon";

struct Zenon;

impl MangaSource for Zenon {
...
<li class="series-list"><a href="/series/sample"><img src="/cover.jpg" alt="Sample Zenon"><h4 class="series-title">Sample Zenon</h4></a></li>
"#;
