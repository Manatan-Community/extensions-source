...
const SOURCE: YoungAnimal = YoungAnimal;
const BASE_URL: &str = "https://younganimal.com";
const API_URL: &str = "https://younganimal.com/api";
const SEARCH_PAGE_SIZE: u64 = 24;

struct YoungAnimal;

impl MangaSource for YoungAnimal {
        ...
        .filter_map(|chunk| {
            ...
            Some(CatalogItem {
                ...
                title: html::text_between(chunk, "series-list-item-h", "</")
                    ...
                    .unwrap_or_else(|| {
                        url::slug_from_url(&key).unwrap_or_else(|| "Young Animal".into())
                    }),
...
const LIST_FIXTURE: &str = r#"<div class="series-list-item"><a class="series-list-item-link" href="/series/sample"><img class="series-list-item-img" src="/cover.jpg"><div class="series-list-item-h"><span>Sample Young Animal</span></div></a></div>"#;
const SEARCH_FIXTURE: &str = r#"{"searchResult":{"series":{"total":1,"series":[{"id":"sample","name":"Sample Young Animal","images":[{"url":"https://img.example.test/cover.jpg"}]}]}}}"#;
const DETAILS_FIXTURE: &str = r#"{"series":{"summary":{"name":"Sample Young Animal","description":"Sample description.","author":[{"name":"Sample Author"}],"images":[{"url":"https://img.example.test/cover.jpg"}],"tag":[{"name":"Action"}],"isCompleted":false},"episodes":[{"id":"sample","title":"Episode 1","datePublished":1704067200}]}}"#;
