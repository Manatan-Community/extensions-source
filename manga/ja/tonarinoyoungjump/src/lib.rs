...
const SOURCE: TonariNoYoungJump = TonariNoYoungJump;
const BASE_URL: &str = "https://tonarinoyj.jp";

struct TonariNoYoungJump;

impl MangaSource for TonariNoYoungJump {
    fn list(&self, request: Value) -> ExtensionResult<Paged<CatalogItem>> {
        ...
        Ok(parse_series_list(&fetch_document(
            &series_collection_url(collection),
            LIST_FIXTURE,
        )))
    }
    ...
    fn search(&self, request: Value) -> ExtensionResult<Paged<CatalogItem>> {
        ...
        let collection = filter_string(&request, "collection").unwrap_or("");
...
fn series_collection_url(collection: &str) -> String {
    if collection.is_empty() || collection == "popular" {
...
fn parse_series_list(body: &str) -> Paged<CatalogItem> {
    let entries = body
        ...
        .filter_map(|chunk| {
            ...
            Some(CatalogItem {
                key: key.clone(),
                title: html::text_between(chunk, "h4 title", "</")
                    .or_else(|| html::text_between(chunk, "<h4", "</h4>"))
                    .map(|value| html::strip_tags(&value))
                    .filter(|value| !value.is_empty())
                    .unwrap_or_else(|| {
                        url::slug_from_url(&key).unwrap_or_else(|| "Tonari no Young Jump".into())
                    }),
                cover: image_from_chunk(chunk)
                    .map(|value| value.replace("{width}", "528").replace("{height}", "528")),
...
const LIST_FIXTURE: &str = r#"<ul class="series-table-list"><li class="subpage-table-list-item"><a href="/series/sample"><div class="subpage-image-wrapper"><img data-src="/cover.jpg"></div><h4 class="title">Sample Tonari no Young Jump</h4></a></li></ul>"#;
const DETAILS_FIXTURE: &str = r#"
<section class="series-information"><div class="series-header"><h1 class="series-header-title">Sample Tonari no Young Jump</h1><h2 class="series-header-author">Sample Author</h2><p class="series-header-description">Sample description.</p><div class="series-header-image-wrapper"><img data-src="/cover.jpg"></div><div class="js-readable-products-pagination" data-aggregate-id="sample"></div></div></section>
"#;
...
const PAGES_JSON: &str = r#"{"readableProduct":{"pageStructure":{"choJuGiga":"","pages":[{"src":"https://tonarinoyj.jp/page1.jpg","type":"main"}]}}}"#;
const PAGES_FIXTURE: &str = r#"<script id="episode-json" data-value="{&quot;readableProduct&quot;:{&quot;pageStructure&quot;:{&quot;choJuGiga&quot;:&quot;&quot;,&quot;pages&quot;:[{&quot;src&quot;:&quot;https://tonarinoyj.jp/page1.jpg&quot;,&quot;type&quot;:&quot;main&quot;}]}}}"></script>"#;
