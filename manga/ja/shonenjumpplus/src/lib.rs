...
const SOURCE: ShonenJumpPlus = ShonenJumpPlus;
const BASE_URL: &str = "https://shonenjumpplus.com";
const SOURCE_NAME: &str = "Shonen Jump+";

struct ShonenJumpPlus;

impl MangaSource for ShonenJumpPlus {
...
<li class="series-list"><a href="/series/sample"><img src="/cover.jpg" alt="Sample Shonen Jump+"><h4 class="series-title">Sample Shonen Jump+</h4></a></li>
"#;
