...
const SOURCE: MangaCan = MangaCan;
const BASE_URL: &str = "https://mangacanblog.com";
const CONTENT_RATING: &str = "adult";
const SAMPLE_MANGA: &str = "/sample-mangacan";

struct MangaCan;

impl MangaSource for MangaCan {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        let key = manga::request_key(&request, "chapter")
            .unwrap_or_else(|| "/sample-mangacan/chapter-1".into());
        Ok(parse_pages(
...
fn search_url(page: u64, query: &str, filters: Option<&Value>) -> String {
    if !query.is_empty() {
        let slug = query
            ...
            .join("-")
            .to_ascii_lowercase();
        return format!("{BASE_URL}/cari/{}/{}.html", url::query_escape(&slug), page);
    }
    if let Some(genre) = filter(filters, "genre").filter(|value| !value.is_empty()) {
        if genre.starts_with("http://") || genre.starts_with("https://") {
            return genre.to_string();
        }
        return url::join_url(BASE_URL, genre);
    }
    BASE_URL.to_string()
}
        ...
        entries: body
            ...
            .filter_map(|chunk| {
                ...
                let title = html::attr_after(chunk, "<a", "title")
                    ...
                    .unwrap_or_else(|| "MangaCan".to_string());
...
<div class="bsx"><a href="https://mangacanblog.com/sample-mangacan/" title="Sample Manga Can"><img src="/cover.jpg" alt="Sample Manga Can"></a></div>
"#;

const DETAILS_FIXTURE: &str = r#"
<h1 class="entry-title">Sample Manga Can</h1>
...
<ul><li class="wp-manga-chapter"><a href="https://mangacanblog.com/sample-mangacan/chapter-1/">Chapter 1</a><span class="chapterdate">Jan 1, 2024</span></li></ul>
"#;

const PAGES_FIXTURE: &str = r#"
<div class="images"><img data-src="https://mangacanblog.com/page1.jpg"></div>
"#;
