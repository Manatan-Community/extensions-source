...
<div class="page-item-detail"><h3 class="post-title"><a href="/komik/sample/">Sample MG Komik</a></h3><img src="/cover.jpg"></div><div class="nav-previous"></div>
"#;
const DETAILS_FIXTURE: &str = r#"
<h1 class="post-title">Sample MG Komik</h1><div class="summary_image"><img src="/cover.jpg"></div><div class="description-summary">Sample description.</div><ul><li class="wp-manga-chapter"><a href="/komik/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">January 1, 2024</span></li></ul>
"#;
