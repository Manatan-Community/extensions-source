...
const SOURCE: KomikindoCo = KomikindoCo;
const CONFIG: ThemesiaConfig = ThemesiaConfig {
    base_url: "https://komiksin.net",
    name: "KomikIndo.co",
    lang: "id",
...
impl MangaSource for KomikindoCo {
...
<div class="listupd">
  <div class="bs"><div class="bsx"><a href="https://komiksin.net/manga/sample/" title="Sample"><img src="https://komiksin.net/cover.jpg" alt="Sample"></a></div></div>
</div>
<div class="pagination"><a class="next page-numbers" href="https://komiksin.net/manga/page/2/">Next</a></div>
"#;

const DETAILS_FIXTURE: &str = r#"
<div class="bigcontent">
  <h1 class="entry-title">Sample</h1>
  <div class="thumb"><img src="https://komiksin.net/cover.jpg"></div>
...
<div id="chapterlist"><li><a href="https://komiksin.net/manga/sample/chapter-1/"><span class="chapternum">Chapter 1</span></a><span class="chapterdate">2024-01-01</span></li></div>
"#;

const PAGES_FIXTURE: &str = r#"
<div id="readerarea"><img src="https://komiksin.net/page-1.jpg" alt="Page 1"></div>
"#;
