...
const SOURCE: DojingNet = DojingNet;
const CONFIG: ThemesiaConfig = ThemesiaConfig {
    base_url: "https://dojing.net",
    name: "Dojing.net",
    lang: "id",
...
impl MangaSource for DojingNet {
...
<div class="listupd">
  <div class="bs"><div class="bsx"><a href="https://dojing.net/manga/sample/" title="Sample"><img src="https://dojing.net/cover.jpg" alt="Sample"></a></div></div>
</div>
<div class="pagination"><a class="next" href="https://dojing.net/manga/page/2/">Next</a></div>
"#;

const DETAILS_FIXTURE: &str = r#"
<div class="bigcontent">
  <h1 class="entry-title">Sample</h1>
  <div class="thumb"><img src="https://dojing.net/cover.jpg"></div>
...
<div id="chapterlist"><li><a href="https://dojing.net/manga/sample/chapter-1/"><span class="chapternum">Chapter 1</span></a><span class="chapterdate">2024-01-01</span></li></div>
"#;

const PAGES_FIXTURE: &str = r#"
<div id="readerarea"><img src="https://dojing.net/page-1.jpg" alt="Page 1"></div>
"#;
