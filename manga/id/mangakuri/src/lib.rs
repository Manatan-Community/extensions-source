...
const SOURCE: Mangakuri = Mangakuri;
const BASE_URL: &str = "https://lc1.mangakuri.online";
const API_URL: &str = "https://api.mangakuri.online/api";

struct Mangakuri;

impl MangaSource for Mangakuri {
    ...
    fn search(&self, request: Value) -> ExtensionResult<Paged<CatalogItem>> {
        ...
        let sort = filter(filters, "sort").unwrap_or("new");
...
impl SeriesDetail {
    fn to_catalog(self, key: Option<String>) -> CatalogItem {
        ...
        CatalogItem {
            ...
            title: self
                .title
                .unwrap_or_else(|| url::slug_from_url(&key).unwrap_or_else(|| "Mangakuri".into())),
            cover: self.poster_image_url,
            description: self
                .synopsis
...
const LIST_FIXTURE: &str = r#"{
  "data": [
    { "title": "Sample Mangakuri", "slug": "sample-mangakuri", "poster_image_url": "https://api.mangakuri.online/sample.jpg" }
  ],
  "total_pages": 1
}"#;

const DETAILS_FIXTURE: &str = r#"{
  "title": "Sample Mangakuri",
  "slug": "sample-mangakuri",
  "synopsis": "<p>Sample synopsis.</p>",
  "poster_image_url": "https://api.mangakuri.online/sample.jpg",
...
const PAGES_FIXTURE: &str = r#"{
  "chapter": { "pages": [
    { "image_url": "https://api.mangakuri.online/page1.jpg?w=300" },
    { "image_url": "/page2.jpg" }
  ] }
}"#;
...
mod tests {
    ...
    fn parses_api_fixtures() {
        ...
        assert_eq!(
            SOURCE
                .chapters(json!({"manga":"/comic/sample-mangakuri"}))
                .unwrap()[0]
                .chapter_number,
            Some(1.0)
        );
        ...
        match &pages[0].content {
            PageContent::Url { url, .. } => {
                assert_eq!(url, "https://api.mangakuri.online/page1.jpg")
            }
