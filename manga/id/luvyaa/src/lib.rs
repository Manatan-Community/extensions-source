...
const SOURCE: Luvyaa = Luvyaa;
const BASE_URL: &str = "https://v4.luvyaa.co";
const CONTENT_RATING: &str = "adult";
const SAMPLE_MANGA: &str = "/manga/sample-luvyaa";

struct Luvyaa;

impl MangaSource for Luvyaa {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        let key = manga::request_key(&request, "chapter")
            .unwrap_or_else(|| "/manga/sample-luvyaa/chapter-1".into());
        Ok(parse_pages(
        ...
        entries: body
            ...
            .filter_map(|chunk| {
                ...
                let title = html::attr_after(chunk, "<a", "title")
                    ...
                    .unwrap_or_else(|| "Luvyaa".to_string());
...
<div class="bsx"><a href="https://v4.luvyaa.co/manga/sample-luvyaa/" title="Sample Luvyaa"><img src="/cover.jpg" alt="Sample Luvyaa"></a></div>
"#;

const DETAILS_FIXTURE: &str = r#"
<h1 class="entry-title">Sample Luvyaa</h1>
...
<script>lockedUrls = ["https://v4.luvyaa.co/manga/sample-luvyaa/chapter-vip/"];</script>
<ul><li class="wp-manga-chapter"><a href="https://v4.luvyaa.co/manga/sample-luvyaa/chapter-1/">Chapter 1</a><span class="chapterdate">Jan 1, 2024</span></li><li class="wp-manga-chapter locked"><a href="https://v4.luvyaa.co/manga/sample-luvyaa/chapter-vip/">Chapter VIP</a></li></ul>
"#;

const PAGES_FIXTURE: &str = r#"
<div class="readerarea"><img data-src="https://v4.luvyaa.co/page1.jpg"></div>
"#;
...
mod tests {
    ...
    fn parses_fixtures() {
        ...
        assert_eq!(parse_chapters(DETAILS_FIXTURE, false).len(), 2);
        assert_eq!(parse_chapters(DETAILS_FIXTURE, true).len(), 1);
