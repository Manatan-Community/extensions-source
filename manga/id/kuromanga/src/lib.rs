...
const SOURCE: KuroManga = KuroManga;
const BASE_URL: &str = "https://kuromanga.me";
const SOURCE_NAME: &str = "Kuro Manga";
const CONTENT_RATING: &str = "safe";
const MANGA_DIR: &str = "manga";
const PROJECT_PAGE: Option<&str> = None;
const REVERSE_CHAPTERS: bool = true;

struct KuroManga;

impl MangaSource for KuroManga {
