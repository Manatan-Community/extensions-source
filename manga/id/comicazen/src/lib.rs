...
const SOURCE: Comicazen = Comicazen;
const BASE_URL: &str = "https://comicazen.com";
const CONTENT_RATING: &str = "safe";
const PER_PAGE: usize = 20;

struct Comicazen;

impl MangaSource for Comicazen {
...
[
  {
    "slug": "sample",
    "title": "Sample Comic",
    "thumbnail": "https://comicazen.com/images/sample.jpg",
    "status": "on-going",
    "type": "Manga",
    "genres": ["Action"],
...
{ "images": ["https://comicazen.com/images/page-1.jpg"] }
"#;
