...
const SOURCE: MaidManga = MaidManga;
const BASE_URL: &str = "https://www.maid.my.id";
const CONTENT_RATING: &str = "adult";
const SAMPLE_MANGA: &str = "/manga/sample-maidmanga";

struct MaidManga;

impl MangaSource for MaidManga {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        let key = manga::request_key(&request, "chapter")
            .unwrap_or_else(|| "/manga/sample-maidmanga/chapter-1".into());
        Ok(parse_pages(
        ...
        entries: body
            ...
            .filter_map(|chunk| {
                ...
                let title = html::attr_after(chunk, "<a", "title")
                    ...
                    .unwrap_or_else(|| "MaidManga".to_string());
...
<div class="bsx"><a href="https://www.maid.my.id/manga/sample-maidmanga/" title="Sample Maid - Manga"><img src="/cover.jpg" alt="Sample Maid - Manga"></a></div>
"#;

const DETAILS_FIXTURE: &str = r#"
<h1 class="entry-title">Sample Maid - Manga</h1>
...
<ul><li class="wp-manga-chapter"><a href="https://www.maid.my.id/manga/sample-maidmanga/chapter-1/">Chapter 1</a><span class="chapterdate">Jan 1, 2024</span></li></ul>
"#;

const PAGES_FIXTURE: &str = r#"
<div class="readerarea"><img data-src="https://www.maid.my.id/page1.jpg"></div>
"#;
