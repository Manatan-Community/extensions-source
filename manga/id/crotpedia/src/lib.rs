...
const SOURCE: CrotPedia = CrotPedia;
const BASE_URL: &str = "https://crotpedia.net";
const CONTENT_RATING: &str = "adult";

struct CrotPedia;

impl MangaSource for CrotPedia {
    ...
    body.split("<div")
        ...
        .filter_map(|chunk| {
            ...
            let title = html::text_between(chunk, "flexbox2-title", "</")
                ...
                .unwrap_or_else(|| {
                    url::slug_from_url(&href).unwrap_or_else(|| "CrotPedia".to_string())
                });
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::text_between(body, "series-title", "</")
            ...
            .unwrap_or_else(|| url::slug_from_url(&key).unwrap_or_else(|| "CrotPedia".to_string())),
...
<div class="flexbox2-item">
  <div class="flexbox2-content"><a href="https://crotpedia.net/series/sample/"><img src="https://crotpedia.net/cover.jpg"></a></div>
...
<div class="series-thumb"><img src="https://crotpedia.net/cover.jpg"></div>
...
<ul class="series-chapterlist"><div class="flexch-infoz"><a href="https://crotpedia.net/sample-chapter-1/"><span>Chapter 1</span><span class="date">2024-01-01</span></a></div></ul>
"#;

const PAGES_FIXTURE: &str = r#"
<div class="reader-area"><img src="https://crotpedia.net/page-1.jpg"></div>
"#;
