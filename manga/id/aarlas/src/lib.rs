...
const SOURCE: Aarlas = Aarlas;
const BASE_URL: &str = "https://www.arlas.online";
const MAX_RESULTS: u64 = 20;

struct Aarlas;

impl MangaSource for Aarlas {
        ...
        entries: body
            ...
            .filter_map(|chunk| {
                ...
                let title = html::text_between(chunk, "figcaption", "</figcaption>")
                    ...
                    .unwrap_or_else(|| "Aarlas".to_string());
...
<div class="PopularPosts"><div class="grid"><figure><img src="/cover.jpg"><figcaption><a href="/p/sample-arlas.html">Sample Aarlas</a></figcaption></figure></div></div>
"#;

const FEED_FIXTURE: &str = r#"{
  "feed": { "entry": [
    { "title": { "$t": "Sample Aarlas" }, "category": [ { "term": "Series" } ], "link": [ { "rel": "alternate", "href": "https://www.arlas.online/p/sample-arlas.html" } ], "media$thumbnail": { "url": "https://blogger.googleusercontent.com/img/s72-c/sample.jpg" } }
  ] }
}"#;

const DETAILS_FIXTURE: &str = r#"
<meta property="og:title" content="Sample Aarlas">
