...
const SOURCE: SekteKomik = SekteKomik;
const BASE_URL: &str = "https://sektekomik.xyz";
const CONTENT_RATING: &str = "safe";
const SOURCE_NAME: &str = "Sekte Komik";

struct SekteKomik;

impl MangaSource for SekteKomik {
...
<div class="product__item"><a class="img-link" href="/manga/sample/"><div class="set-bg" data-setbg="/cover.jpg"></div><h5>Sample Sekte Komik</h5></a></div><i class="fa-angle-right"></i>
"#;
const DETAILS_FIXTURE: &str = r#"
<div class="anime__details__content"><div class="set-bg" data-setbg="/cover.jpg"></div><h3>Sample Sekte Komik</h3><span>Writer</span><p>Sample synopsis.</p><ul><li>Status Ongoing</li></ul></div>
<div class="anime__details__episodes"><a href="/manga/sample/chapter-1/">Chapter 1</a></div>
"#;
const PAGES_FIXTURE: &str = r#"<div class="read-img"><img src="/page1.jpg"></div>"#;
...
mod tests {
    ...
    fn parses_fixtures() {
        assert_eq!(
            parse_listing_page(LIST_FIXTURE).entries[0].title,
            "Sample Sekte Komik"
        );
        assert_eq!(
