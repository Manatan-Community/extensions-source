...
const SOURCE: ToonCubus = ToonCubus;
const BASE_URL: &str = "https://www.tooncubus.top";
const MAX_RESULTS: u64 = 20;

struct ToonCubus;

impl MangaSource for ToonCubus {
    ...
    fn details(&self, request: Value) -> ExtensionResult<CatalogItem> {
        let key =
            manga::request_key(&request, "manga").unwrap_or_else(|| "/p/sample-tooncubus.html".into());
        Ok(parse_details(
        ...
        entries: body
            ...
            .filter_map(|chunk| {
                ...
                let title = html::text_between(chunk, "figcaption", "</figcaption>")
                    ...
                    .unwrap_or_else(|| "ToonCubus".to_string());
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    let key = key.unwrap_or_else(|| "/p/sample-tooncubus.html".to_string());
...
<div class="PopularPosts"><div class="grid"><figure><img src="/cover.jpg"><figcaption><a href="/p/sample-arlas.html">Sample ToonCubus</a></figcaption></figure></div></div>
"#;

const FEED_FIXTURE: &str = r#"{
  "feed": { "entry": [
    { "title": { "$t": "Sample ToonCubus" }, "category": [ { "term": "Series" } ], "link": [ { "rel": "alternate", "href": "https://www.tooncubus.top/p/sample-arlas.html" } ], "media$thumbnail": { "url": "https://blogger.googleusercontent.com/img/s72-c/sample.jpg" } }
  ] }
}"#;

const DETAILS_FIXTURE: &str = r#"
<meta property="og:title" content="Sample ToonCubus">
...
const CHAPTER_FEED_FIXTURE: &str = r#"{
  "feed": { "entry": [
    { "title": { "$t": "Chapter 1" }, "published": { "$t": "2024-01-01T00:00:00.000+07:00" }, "updated": { "$t": "2024-01-02T00:00:00.000+07:00" }, "category": [ { "term": "Chapter" } ], "link": [ { "rel": "alternate", "href": "https://www.tooncubus.top/2024/01/sample-chapter-1.html" } ] }
  ] }
}"#;
