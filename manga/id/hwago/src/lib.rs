...
const SOURCE: Hwago = Hwago;
const CONFIG: MadaraConfig = MadaraConfig {
    base_url: "https://01.hwago.xyz",
    lang: "id",
...
impl MangaSource for Hwago {
    ...
    fn search(&self, request: Value) -> ExtensionResult<Paged<CatalogItem>> {
        holotoon_like_search(&CONFIG, request)
    }

    fn details(&self, request: Value) -> ExtensionResult<CatalogItem> {
        holotoon_like_details(&CONFIG, request)
    }

    fn chapters(&self, request: Value) -> ExtensionResult<Vec<MangaChapter>> {
        holotoon_like_chapters(&CONFIG, request)
    }

    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        holotoon_like_pages(&CONFIG, request)
    }
    ...
    fn handle_url(&self, request: Value) -> ExtensionResult<Option<UrlResolveResult>> {
        holotoon_like_handle_url(&CONFIG, request)
    }
}
...
fn holotoon_like_details(config: &MadaraConfig, request: Value) -> ExtensionResult<CatalogItem> {
...
fn holotoon_like_pages(config: &MadaraConfig, request: Value) -> ExtensionResult<Vec<MangaPage>> {
...
<div class="page-item-detail"><h3 class="post-title"><a href="/komik/sample/">Sample Hwago</a></h3><img src="/cover.jpg"></div><div class="nav-previous"></div>
"#;
const DETAILS_FIXTURE: &str = r#"
<h1 class="post-title">Sample Hwago</h1><div class="summary_image"><img src="/cover.jpg"></div><div class="description-summary">Sample description.</div><ul><li class="wp-manga-chapter"><a href="/komik/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">1 January 2024</span></li></ul>
"#;
