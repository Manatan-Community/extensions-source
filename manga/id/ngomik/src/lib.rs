...
const SOURCE: Ngomik = Ngomik;
const CONFIG: ThemesiaConfig = ThemesiaConfig {
    base_url: "https://id.ngomik.cloud",
    name: "Ngomik (unoriginal)",
    lang: "id",
    content_rating: "adult",
    manga_dir: "/manga",
    project_page: Some("/pj"),
    resize_covers: false,
};
...
<div class="listupd">
  <div class="bs"><div class="bsx"><a href="https://id.ngomik.cloud/manga/sample/" title="Sample"><img src="https://id.ngomik.cloud/cover.jpg" alt="Sample"></a></div></div>
</div>
<div class="pagination"><a class="next page-numbers" href="https://id.ngomik.cloud/manga/page/2/">Next</a></div>
"#;

const DETAILS_FIXTURE: &str = r#"
<div class="bigcontent">
  <h1 class="entry-title">Sample</h1>
  <div class="thumb"><img src="https://id.ngomik.cloud/cover.jpg"></div>
...
<div id="chapterlist"><li><a href="https://id.ngomik.cloud/manga/sample/chapter-1/"><span class="chapternum">Chapter 1</span></a><span class="chapterdate">2024-01-01</span></li></div>
"#;

const PAGES_FIXTURE: &str = r#"
<div id="readerarea"><img src="https://id.ngomik.cloud/page-1.jpg" alt="Page 1"></div>
"#;
