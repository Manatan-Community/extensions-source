...
const SOURCE: KumaPoi = KumaPoi;
const BASE_URL: &str = "https://kumapoi.info";
const SOURCE_NAME: &str = "KumaPoi";
const CONTENT_RATING: &str = "adult";
const MANGA_DIR: &str = "manga";
const PROJECT_PAGE: Option<&str> = Some("project");
const REVERSE_CHAPTERS: bool = false;

struct KumaPoi;

impl MangaSource for KumaPoi {
