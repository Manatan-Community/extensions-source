...
const SOURCE: KlikManga = KlikManga;
const BASE_URL: &str = "https://klikmanga.org";

struct KlikManga;

impl MangaSource for KlikManga {
    ...
    fn details(&self, request: Value) -> ExtensionResult<CatalogItem> {
        ...
        let key = manga::request_key(&request, "manga")
            .unwrap_or_else(|| "/daftar-komik/sample".to_string());
        let body =
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        ...
        let key = manga::request_key(&request, "chapter")
            .unwrap_or_else(|| "/daftar-komik/sample/chapter-1".to_string());
        let body =
...
<div class="page-item-detail"><h3 class="post-title"><a href="/daftar-komik/sample/">Sample Manga</a></h3><img src="/cover.jpg"></div>
...
<ul><li class="wp-manga-chapter"><a href="/daftar-komik/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">2024-01-01</span></li></ul>
"#;
