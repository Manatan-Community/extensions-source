...
const BASE_URL: &str = "https://komikdewasa.mom";
const SOURCE_NAME: &str = "Komik Dewasa";
const MANGA_PATH: &str = "komik";
const LANG: &str = "id";
...
<div class="listupd"><div class="bsx"><a href="/komik/sample/" title="Sample Manga"><img src="/cover.jpg"><h2>Sample Manga</h2></a></div><a class="next page-numbers"></a></div>
"#;
