...
const SOURCE: CosmicScansID = CosmicScansID;
const CONFIG: ThemesiaConfig = ThemesiaConfig {
    base_url: "https://lc1.cosmicscans.to",
    name: "CosmicScans.id",
    lang: "id",
    content_rating: "safe",
    manga_dir: "/manga",
    ...
    fn normalize_key(&self, value: &str) -> String {
        if value.starts_with("http://") || value.starts_with("https://") {
            if let Some(index) = value.find(self.base_url) {
                let path = value[index + self.base_url.len()..].trim_matches('/');
                return format!("/{path}");
            }
        }
...
impl MangaSource for CosmicScansID {
...
fn themesia_search_url(page: u64, query: &str, order: Option<&str>, filters: &Value) -> String {
    if CONFIG.cosmic_search && !query.is_empty() {
        return format!(
            "{}/page/{page}/?s={}",
    ...
    let path = if CONFIG.has_project_page
        && filter_string(filters, "project").as_deref() == Some("project-filter-on")
    {
        "/project"
    } else {
        CONFIG.manga_dir
...
<div class="listupd">
  <div class="bs"><div class="bsx"><a href="https://lc1.cosmicscans.to/manga/sample/" title="Sample"><img src="https://lc1.cosmicscans.to/cover.jpg" alt="Sample"></a></div></div>
</div>
<div class="pagination"><a class="next" href="https://lc1.cosmicscans.to/manga/page/2/">Next</a></div>
"#;

const DETAILS_FIXTURE: &str = r#"
<div class="bigcontent">
  <h1 class="entry-title">Sample</h1>
  <div class="thumb"><img src="https://lc1.cosmicscans.to/cover.jpg"></div>
...
<div id="chapterlist"><li><a href="https://lc1.cosmicscans.to/manga/sample/chapter-1/"><span class="chapternum">Chapter 1</span></a><span class="chapterdate">2024-01-01</span></li></div>
"#;

const PAGES_FIXTURE: &str = r#"
<div id="readerarea"><img src="https://lc1.cosmicscans.to/page-1.jpg" alt="Page 1"></div>
"#;
...
mod tests {
    ...
    fn parses_themesia_fixture() {
        ...
        assert_eq!(parse_chapters(DETAILS_FIXTURE, "/komik/sample").len(), 1);
