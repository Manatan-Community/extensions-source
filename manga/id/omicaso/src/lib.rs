...
const SOURCE: Omicaso = Omicaso;
const CONFIG: ThemesiaConfig = ThemesiaConfig {
    base_url: "https://omicaso.org",
    name: "Omicaso",
    lang: "id",
...
<div class="listupd">
  <div class="bs"><div class="bsx"><a href="https://omicaso.org/comik/sample/" title="Sample Omicaso"><img src="https://omicaso.org/cover.jpg" alt="Sample Omicaso"></a></div></div>
</div>
<div class="pagination"><a class="next page-numbers" href="https://omicaso.org/comik/page/2/">Next</a></div>
"#;

const DETAILS_FIXTURE: &str = r#"
<div class="bigcontent">
  <h1 class="entry-title">Sample Omicaso</h1>
  <div class="thumb"><img src="https://omicaso.org/cover.jpg"></div>
...
<div id="chapterlist"><li><a href="https://omicaso.org/comik/sample/chapter-1/"><span class="chapternum">Chapter 1</span></a><span class="chapterdate">2024-01-01</span></li></div>
"#;

const PAGES_FIXTURE: &str = r#"
<div id="readerarea"><img src="https://omicaso.org/page-1.jpg" alt="Page 1"></div>
"#;
...
mod tests {
    ...
    fn parses_themesia_fixture() {
        ...
        assert_eq!(parse_chapters(DETAILS_FIXTURE, "/comik/sample").len(), 1);
