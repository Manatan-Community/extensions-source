...
const SOURCE: MrTenzus = MrTenzus;

struct MrTenzus;

impl manga::MadaraSource for MrTenzus {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig {
            base_url: "https://mrtenzus.com",
            lang: "pt-BR",
...
impl_madara_source!(MrTenzus);
export_manga_source!(SOURCE);

const LIST_FIXTURE: &str = r#"<div class="page-item-detail"><h3 class="post-title"><a href="/manga/sample/">Sample Manga</a></h3><img src="/cover.jpg"></div><div class="no-posts"></div>"#;
