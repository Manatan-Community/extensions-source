...
const SOURCE: CafeComYaoi = CafeComYaoi;
const BASE_URL: &str = "https://cafecomyaoi.com.br";
...
impl MangaSource for CafeComYaoi {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        ...
        let pages = parse_cafecomyaoi_pages(&body);
        if pages.is_empty() {
...
fn parse_cafecomyaoi_pages(body: &str) -> Vec<MangaPage> {
    body.split("<img")
        .skip(1)
        .filter(|chunk| {
...
<div class="page-item-detail">
  <h3 class="post-title"><a href="/manga/sample/">Sample Café com Yaoi</a></h3>
  <img src="/cover.jpg">
</div>
...
<h1 class="post-title">Sample Café com Yaoi</h1>
...
mod tests {
    ...
    fn parses_fixture() {
        assert_eq!(
            ...
            "Sample Café com Yaoi"
        );
        assert_eq!(parse_cafecomyaoi_pages(PAGES_FIXTURE).len(), 2);
    }
}
