...
const SOURCE: PinkSeaUnicorn = PinkSeaUnicorn;

struct PinkSeaUnicorn;

impl manga::MadaraSource for PinkSeaUnicorn {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig {
            base_url: "https://psunicorn.com",
            lang: "pt-BR",
...
impl_madara_source!(PinkSeaUnicorn);
