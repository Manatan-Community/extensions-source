...
const SOURCE: MangaLivreTo = MangaLivreTo;
const BASE_URL: &str = "https://mangalivre.to";

struct MangaLivreTo;

impl MadaraSource for MangaLivreTo {
...
impl_madara_source!(MangaLivreTo);
export_manga_source!(SOURCE);

const LIST_FIXTURE: &str = r#"
<div class="page-item-detail">
  <h3 class="post-title"><a href="/manga/sample/">Sample Manga Livre.to</a></h3>
  <img src="/cover.jpg">
</div>
"#;

const DETAILS_FIXTURE: &str = r#"
<h1 class="post-title">Sample Manga Livre.to</h1>
