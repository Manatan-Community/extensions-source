...
const SOURCE: MiniTwoScan = MiniTwoScan;
const BASE_URL: &str = "https://minitwoscan.com";

struct MiniTwoScan;

impl MadaraSource for MiniTwoScan {
...
impl_madara_source!(MiniTwoScan);
export_manga_source!(SOURCE);

const LIST_FIXTURE: &str = r#"
<div class="page-item-detail">
  <h3 class="post-title"><a href="/manga/sample/">Sample MiniTwo Scan</a></h3>
  <img src="/cover.jpg">
</div>
"#;

const DETAILS_FIXTURE: &str = r#"
<h1 class="post-title">Sample MiniTwo Scan</h1>
