...
const SOURCE: FenixProject = FenixProject;

struct FenixProject;

impl MadaraSource for FenixProject {
    fn madara_config(&self, _request: &Value) -> MadaraConfig {
        MadaraConfig {
            base_url: "https://fenixproject.site",
            lang: "pt-BR",
...
impl_madara_source!(FenixProject);
export_manga_source!(SOURCE);

const LIST_FIXTURE: &str = r#"
<div class="page-item-detail"><h3 class="post-title"><a href="/manga/sample/">Sample Fenix</a></h3><img src="/cover.jpg"></div>
<div class="nav-previous"></div>
"#;

const DETAILS_FIXTURE: &str = r#"
<h1 class="post-title">Sample Fenix</h1><div class="summary_image"><img src="/cover.jpg"></div>
