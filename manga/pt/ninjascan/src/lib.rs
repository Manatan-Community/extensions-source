...
const SOURCE: NinjaScan = NinjaScan;

struct NinjaScan;

impl manga::MadaraSource for NinjaScan {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig {
            base_url: "https://ninjacomics.xyz",
            lang: "pt-BR",
            content_rating: "safe",
            manga_path: "manga",
...
const DETAILS_FIXTURE: &str = r#"<h1 class="post-title">Sample Manga</h1><div class="summary_image"><img src="/cover.jpg"></div><ul><li class="wp-manga-chapter"><a href="/manga/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">01 January 2024</span></li></ul>"#;
