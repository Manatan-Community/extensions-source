...
const SOURCE: BorutoExplorer = BorutoExplorer;
const BASE_URL: &str = "https://leitor.borutoexplorer.com.br";

struct BorutoExplorer;

impl MadaraSource for BorutoExplorer {
...
impl_madara_source!(BorutoExplorer);
export_manga_source!(SOURCE);

const LIST_FIXTURE: &str = r#"
<div class="page-item-detail">
  <h3 class="post-title"><a href="/manga/sample/">Sample Boruto Explorer</a></h3>
  <img src="/cover.jpg">
</div>
"#;

const DETAILS_FIXTURE: &str = r#"
<h1 class="post-title">Sample Boruto Explorer</h1>
