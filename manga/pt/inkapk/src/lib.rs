...
const SOURCE: Inkapk = Inkapk;
const BASE_URL: &str = "https://inkapk.net";
...
impl MangaSource for Inkapk {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        ...
        let pages = parse_inkapk_pages(&body);
        if pages.is_empty() {
...
fn parse_inkapk_pages(body: &str) -> Vec<MangaPage> {
    body.split("<img")
        .skip(1)
        .filter(|chunk| {
...
<div class="page-item-detail">
  <h3 class="post-title"><a href="/manga/sample/">Sample Inkapk</a></h3>
  <img src="/cover.jpg">
</div>
...
<h1 class="post-title">Sample Inkapk</h1>
...
mod tests {
    ...
    fn parses_fixture() {
        ...
        assert_eq!(parse_inkapk_pages(PAGES_FIXTURE).len(), 2);
    }
}
