...
const SOURCE: Hipercool = Hipercool;
const BASE_URL: &str = "https://hiper.cool";

struct Hipercool;

impl MadaraSource for Hipercool {
...
impl_madara_source!(Hipercool);
export_manga_source!(SOURCE);

const LIST_FIXTURE: &str = r#"
<div class="page-item-detail">
  <h3 class="post-title"><a href="/manga/sample/">Sample HipercooL</a></h3>
  <img src="/cover.jpg">
</div>
"#;

const DETAILS_FIXTURE: &str = r#"
<h1 class="post-title">Sample HipercooL</h1>
