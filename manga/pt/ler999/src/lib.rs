...
const SOURCE: Ler999 = Ler999;
const BASE_URL: &str = "https://ler999.blogspot.com";
const NAME: &str = "Ler 999";
const LANG: &str = "pt-BR";
const CONTENT_RATING: &str = "safe";
const MAX_RESULTS: u64 = 20;
const CHAPTER_RESULTS: u64 = 999_999;
const CHAPTER_LABEL: &str = "Chapter";

struct Ler999;

impl MangaSource for Ler999 {
...
<div id="PopularPosts2"><article><a href="https://ler999.blogspot.com/p/sample.html"><img src="https://blogger.googleusercontent.com/img/s72-c/cover.jpg"></a><h3>Sample Ler 999</h3></article></div>
"#;
const LIST_FIXTURE: &str = r#"{"feed":{"entry":[{"title":{"$t":"Sample Ler 999"},"link":[{"rel":"alternate","href":"https://ler999.blogspot.com/p/sample.html"}],"media$thumbnail":{"url":"https://blogger.googleusercontent.com/img/s72-c/cover.jpg"}}]}}"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample Ler 999</h1><meta property="og:image" content="https://blogger.googleusercontent.com/img/s72-c/cover.jpg">
<div id="synopsis">Sample description.</div><div class="grid gta-series"><dt>Genre</dt><dd><a rel="tag">Acao</a></dd></div>
"#;
const CHAPTERS_FIXTURE: &str = r#"{"feed":{"entry":[{"title":{"$t":"Capitulo 1"},"published":{"$t":"2024-01-01T00:00:00.000Z"},"link":[{"rel":"alternate","href":"https://ler999.blogspot.com/2024/01/sample-chapter-1.html"}]}]}}"#;
