...
const SOURCE: NocturneSummer = NocturneSummer;

struct NocturneSummer;

impl manga::MadaraSource for NocturneSummer {
    fn madara_config(&self, _request: &serde_json::Value) -> MadaraConfig {
        MadaraConfig {
            base_url: "https://nocfsb.com",
            lang: "pt-BR",
...
impl_madara_source!(NocturneSummer);
