...
const SOURCE: MangaOnline = MangaOnline;
const BASE_URL: &str = "https://mangaonline.red";
...
impl MangaSource for MangaOnline {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        ...
        let pages = parse_mangaonline_pages(&body);
        if pages.is_empty() {
...
fn parse_mangaonline_pages(body: &str) -> Vec<MangaPage> {
    body.split("<img")
        .skip(1)
        .filter(|chunk| {
...
<div class="page-item-detail">
  <h3 class="post-title"><a href="/manga/sample/">Sample Manga Online</a></h3>
  <img src="/cover.jpg">
</div>
...
<h1 class="post-title">Sample Manga Online</h1>
...
mod tests {
    ...
    fn parses_fixture() {
        ...
        assert_eq!(parse_mangaonline_pages(PAGES_FIXTURE).len(), 2);
    }
}
