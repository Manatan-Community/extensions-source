...
const SOURCE: KamiSamaExplorer = KamiSamaExplorer;
const BASE_URL: &str = "https://leitor.kamisama.com.br";

struct KamiSamaExplorer;

impl MadaraSource for KamiSamaExplorer {
...
impl_madara_source!(KamiSamaExplorer);
export_manga_source!(SOURCE);

const LIST_FIXTURE: &str = r#"
<div class="page-item-detail">
  <h3 class="post-title"><a href="/manga/sample/">Sample Kami Sama Explorer</a></h3>
  <img src="/cover.jpg">
</div>
"#;

const DETAILS_FIXTURE: &str = r#"
<h1 class="post-title">Sample Kami Sama Explorer</h1>
