...
const SOURCE: Monsure = Monsure;
const BASE_URL: &str = "https://monsuresu.com";
...
impl MangaSource for Monsure {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        ...
        let pages = parse_monsure_pages(&body);
        if pages.is_empty() {
...
fn parse_monsure_pages(body: &str) -> Vec<MangaPage> {
    body.split("<img")
        .skip(1)
        .filter(|chunk| {
...
<div class="page-item-detail">
  <h3 class="post-title"><a href="/manga/sample/">Sample Monsure</a></h3>
  <img src="/cover.jpg">
</div>
...
<h1 class="post-title">Sample Monsure</h1>
...
mod tests {
    ...
    fn parses_fixture() {
        ...
        assert_eq!(parse_monsure_pages(PAGES_FIXTURE).len(), 2);
    }
}
