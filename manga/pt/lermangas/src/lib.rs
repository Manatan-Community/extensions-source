...
const SOURCE: LerMangas = LerMangas;
const BASE_URL: &str = "https://lermangas.me";

struct LerMangas;

impl MadaraSource for LerMangas {
...
impl_madara_source!(LerMangas);
export_manga_source!(SOURCE);

const LIST_FIXTURE: &str = r#"
<div class="page-item-detail">
  <h3 class="post-title"><a href="/manga/sample/">Sample Ler Mangas</a></h3>
  <img src="/cover.jpg">
</div>
"#;

const DETAILS_FIXTURE: &str = r#"
<h1 class="post-title">Sample Ler Mangas</h1>
