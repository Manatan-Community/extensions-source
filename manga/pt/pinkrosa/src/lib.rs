...
const SOURCE: PinkRosa = PinkRosa;
const BASE_URL: &str = "https://scanpinkrosa.blogspot.com";
const NAME: &str = "Pink Rosa";
...
fn parse_details(body: &str, key: &str) -> CatalogItem {
    ...
    CatalogItem {
        ...
        description: html::text_between(body, "id=\"syn_bod\"", "</")
            .or_else(|| html::text_between(body, "id='syn_bod'", "</"))
            .or_else(|| html::text_between(body, "id=\"synopsis\"", "</"))
            .or_else(|| html::text_between(body, "id='synopsis'", "</"))
            .map(|value| html::strip_tags(&value))
            .filter(|value| !value.is_empty()),
        tags: link_values(body, "search/label"),
        authors: text_by_id(body, "tauther").into_iter().collect(),
...
const LIST_FIXTURE: &str = r#"{"feed":{"entry":[{"title":{"$t":"Sample Rosa"},"link":[{"rel":"alternate","href":"https://scanpinkrosa.blogspot.com/p/sample.html"}],"media$thumbnail":{"url":"https://1.bp.blogspot.com/s72-c/sample.jpg"}}]}}"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample Rosa</h1><div class="thum" style="background-image:url(&quot;/cover.jpg&quot;)"></div>
<div id="syn_bod">Sample description.</div><span id="tauther">Sample Author</span><a href="/search/label/Romance" rel="tag">Romance</a>
<div class="bg-green"><span>Em lançamento</span></div><div class="chapter_get" data-labelchapter="Sample"></div>
"#;
const CHAPTERS_FIXTURE: &str = r#"{"feed":{"entry":[{"title":{"$t":"Capitulo 1"},"category":[{"term":"Chapter"}],"published":{"$t":"2024-01-01T00:00:00.000Z"},"link":[{"rel":"alternate","href":"https://scanpinkrosa.blogspot.com/2024/01/sample.html"}]}]}}"#;
