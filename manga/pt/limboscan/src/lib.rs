...
const SOURCE: LimboScan = LimboScan;
const BASE_URL: &str = "https://limboscan.com.br";
...
impl MangaSource for LimboScan {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        ...
        let pages = parse_limboscan_pages(&body);
        if pages.is_empty() {
...
fn parse_limboscan_pages(body: &str) -> Vec<MangaPage> {
    body.split("<img")
        .skip(1)
        .filter(|chunk| {
...
<div class="page-item-detail">
  <h3 class="post-title"><a href="/manga/sample/">Sample Limbo Scan</a></h3>
  <img src="/cover.jpg">
</div>
...
<h1 class="post-title">Sample Limbo Scan</h1>
...
mod tests {
    ...
    fn parses_fixture() {
        ...
        assert_eq!(parse_limboscan_pages(PAGES_FIXTURE).len(), 2);
    }
}
