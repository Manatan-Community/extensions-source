...
const SOURCE: Senkuro = Senkuro;
const NAME: &str = "Senkuro";
const DEFAULT_BASE_URL: &str = "https://senkuro.com";
const DEFAULT_API: &str = "https://api.senkuro.me";
const APP_ID: &str = "4026531840100";
const PAGE_SIZE: u64 = 20;

struct Senkuro;

impl MangaSource for Senkuro {
...
fn base_url(request: &Value) -> String {
    ...
    if api == DEFAULT_API { "https://senkuro.me".into() } else { DEFAULT_BASE_URL.into() }
}
