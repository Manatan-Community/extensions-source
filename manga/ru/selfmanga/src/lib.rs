...
const SOURCE: SelfManga = SelfManga;
const DEFAULT_BASE_URL: &str = "https://1.selfmanga.live";
const NAME: &str = "SelfManga";
const NEED_AUTH: bool = false;
...
impl MangaSource for SelfManga {
