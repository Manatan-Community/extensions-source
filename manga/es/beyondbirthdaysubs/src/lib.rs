...
const SOURCE: BeyondBirthdaySubs = BeyondBirthdaySubs;
const BASE_URL: &str = "https://capibaratraductor.com/beyondbirthdaysubs";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "beyondbirthdaysubs";

struct BeyondBirthdaySubs;

impl MangaSource for BeyondBirthdaySubs {
