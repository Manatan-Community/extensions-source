...
const SOURCE: BeegGimp = BeegGimp;
const BASE_URL: &str = "https://capibaratraductor.com/beeggimp";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "beeggimp";
const NAME: &str = "Beeg Gimp";
const LANG: &str = "es";
