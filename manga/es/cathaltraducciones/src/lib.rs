...
const SOURCE: CathalTraducciones = CathalTraducciones;
const BASE_URL: &str = "https://capibaratraductor.com/cathaltl";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "cathaltl";

struct CathalTraducciones;

impl MangaSource for CathalTraducciones {
