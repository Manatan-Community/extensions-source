...
const SOURCE: NeroTranslations = NeroTranslations;
const BASE_URL: &str = "https://capibaratraductor.com/nerotranslate";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "nerotranslate";
const NAME: &str = "NeroTranslations";
const LANG: &str = "es";
const CONTENT_RATING: &str = "safe";
const PAGE_LIMIT: u64 = 36;

struct NeroTranslations;

impl MangaSource for NeroTranslations {
