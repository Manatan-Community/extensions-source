...
const SOURCE: DokjasheartScanlation = DokjasheartScanlation;
const BASE_URL: &str = "https://capibaratraductor.com/dokjasheart";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "dokjasheart";

struct DokjasheartScanlation;

impl MangaSource for DokjasheartScanlation {
