...
const SOURCE: YuriOnline = YuriOnline;
const CONFIG: MadaraConfig = MadaraConfig {
    base_url: "https://yuri-online.com",
    lang: "es",
...
impl MangaSource for YuriOnline {
...
<div class="page-item-detail"><h3 class="post-title"><a href="/manga/sample/">Sample Yuri</a></h3><img src="/cover.jpg"></div>
</div><div class="nav-previous"></div>
"#;
const DETAILS_FIXTURE: &str = r#"
<div class="post-title"><h1>Sample Yuri</h1></div>
...
<ul class="main version-chap"><li class="wp-manga-chapter"><a href="/manga/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">ene 01, 2024</span></li></ul>
"#;
