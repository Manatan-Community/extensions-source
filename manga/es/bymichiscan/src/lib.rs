...
const SOURCE: BymichiScan = BymichiScan;
const BASE_URL: &str = "https://bymichiby.com";

struct BymichiScan;

impl MangaSource for BymichiScan {
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::text_between(body, "<h1", "</h1>")
            ...
            .unwrap_or_else(|| "Bymichi Scan".to_string()),
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/manga/sample"><img title="Sample Bymichi Scan" src="/cover.jpg"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample Bymichi Scan</h1><img alt="poster" src="/cover.jpg"><div class="comic-content mobile">A sample.</div>
