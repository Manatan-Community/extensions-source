...
const SOURCE: LectorMangaLat = LectorMangaLat;

struct LectorMangaLat;

impl MangaSource for LectorMangaLat {
    ...
    fn details(&self, request: Value) -> ExtensionResult<CatalogItem> {
        ...
        let key = manga::request_key(&request, "manga")
            .unwrap_or_else(|| "/biblioteca/sample".to_string());
        let body =
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        ...
        let key = manga::request_key(&request, "chapter")
            .unwrap_or_else(|| "/biblioteca/sample/chapter-1".to_string());
        let body =
...
<div class="page-item-detail"><h3 class="post-title"><a href="/biblioteca/sample/">Sample Manga</a></h3><img src="/cover.jpg"></div>
<div class="nav-previous"></div>
"#;
const DETAILS_FIXTURE: &str = r#"
<div class="post-title"><h1>Sample Manga</h1></div><div class="summary_image"><img src="/cover.jpg"></div>
<ul class="main version-chap"><li class="wp-manga-chapter"><a href="/biblioteca/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">2024-01-01</span></li><li class="wp-manga-chapter"><span class="locked-badge"></span><a href="/biblioteca/sample/premium/">Premium</a></li></ul>
"#;
const PAGES_FIXTURE: &str =
    r#"<div class="reading-content"><img data-src="/page1.jpg"><img src="/page2.jpg"></div>"#;
...
mod tests {
    ...
    fn skips_premium_chapters() {
        let chapters = SOURCE
            .chapters(json!({"manga":"/biblioteca/sample"}))
            .unwrap();
