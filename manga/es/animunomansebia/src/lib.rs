...
const SOURCE: AnimuNoMansebia = AnimuNoMansebia;
const BASE_URL: &str = "https://capibaratraductor.com/animunm";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "animunm";
const NAME: &str = "Animu No Mansebia";
const LANG: &str = "es";
const CONTENT_RATING: &str = "safe";
const PAGE_LIMIT: u64 = 36;

struct AnimuNoMansebia;

impl MangaSource for AnimuNoMansebia {
