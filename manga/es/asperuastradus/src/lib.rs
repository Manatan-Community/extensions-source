...
const SOURCE: AsperuasTradus = AsperuasTradus;
const BASE_URL: &str = "https://capibaratraductor.com/asperuastradus";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "asperuastradus";

struct AsperuasTradus;

impl MangaSource for AsperuasTradus {
