...
const SOURCE: LolietAzura = LolietAzura;
const BASE_URL: &str = "https://capibaratraductor.com/lolietazura";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "lolietazura";
const NAME: &str = "Loliet Azura Translations";
const LANG: &str = "es";
...
impl MangaSource for LolietAzura {
