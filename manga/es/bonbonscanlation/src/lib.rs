...
const SOURCE: BonbonScanlation = BonbonScanlation;
const BASE_URL: &str = "https://capibaratraductor.com/bonbonscanlation";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "bonbonscanlation";

struct BonbonScanlation;

impl MangaSource for BonbonScanlation {
