...
const SOURCE: CultoASlanesh = CultoASlanesh;
const BASE_URL: &str = "https://capibaratraductor.com/cultoaslanesh";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "cultoaslanesh";

struct CultoASlanesh;

impl MangaSource for CultoASlanesh {
