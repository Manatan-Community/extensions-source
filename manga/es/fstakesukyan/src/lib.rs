...
const SOURCE: FstakeSukyan = FstakeSukyan;
const BASE_URL: &str = "https://capibaratraductor.com/fstakesukyan";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "fstakesukyan";
const NAME: &str = "Fstake Sukyan";
const LANG: &str = "es";
...
impl MangaSource for FstakeSukyan {
