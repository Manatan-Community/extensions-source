...
const SOURCE: KirishimaFansub = KirishimaFansub;
const BASE_URL: &str = "https://capibaratraductor.com/kirishimafansub";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "kirishimafansub";

struct KirishimaFansub;

impl MangaSource for KirishimaFansub {
