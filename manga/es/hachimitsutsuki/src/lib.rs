...
const SOURCE: HachimitsuTsuki = HachimitsuTsuki;
const BASE_URL: &str = "https://capibaratraductor.com/shojopapers";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "shojopapers";
const NAME: &str = "Hachimitsu Tsuki";
const LANG: &str = "es";
const CONTENT_RATING: &str = "safe";
const PAGE_LIMIT: u64 = 36;

struct HachimitsuTsuki;

impl MangaSource for HachimitsuTsuki {
