...
const SOURCE: AzureBloom = AzureBloom;
const BASE_URL: &str = "https://capibaratraductor.com/azurebloom";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "azurebloom";
const NAME: &str = "Azure Bloom";
const LANG: &str = "es";
...
impl MangaSource for AzureBloom {
