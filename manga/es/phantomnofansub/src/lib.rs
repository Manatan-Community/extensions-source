...
const SOURCE: PhantomNoFansub = PhantomNoFansub;
const BASE_URL: &str = "https://capibaratraductor.com/phantomnofansub";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "phantomnofansub";
const NAME: &str = "Phantom No Fansub";
const LANG: &str = "es";
const CONTENT_RATING: &str = "safe";
const PAGE_LIMIT: u64 = 36;

struct PhantomNoFansub;

impl MangaSource for PhantomNoFansub {
