...
const SOURCE: OmegaScanlation = OmegaScanlation;
const BASE_URL: &str = "https://capibaratraductor.com/omegascanlation";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "omegascanlation";
const NAME: &str = "Omega Scanlation";
const LANG: &str = "es";
const CONTENT_RATING: &str = "adult";
const PAGE_LIMIT: u64 = 36;

struct OmegaScanlation;

impl MangaSource for OmegaScanlation {
