...
const SOURCE: ElScanSemanal = ElScanSemanal;
const BASE_URL: &str = "https://capibaratraductor.com/elscansemanal";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "elscansemanal";

struct ElScanSemanal;

impl MangaSource for ElScanSemanal {
