...
const SOURCE: RaikiScan = RaikiScan;
const BASE_URL: &str = "https://raikiscan.com";
const SOURCE_NAME: &str = "Raiki Scan";
const CONTENT_RATING: &str = "safe";

struct RaikiScan;

impl MangaSource for RaikiScan {
...
const LIST_FIXTURE: &str = r#"<div class="listupd"><div class="bs"><div class="bsx"><a href="/manga/sample" title="Sample Shojo"><img src="/cover.jpg"></a></div></div></div><div class="pagination"><a class="next"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"<div class="bigcontent"><h1 class="entry-title">Sample Shojo</h1><div class="thumb"><img src="/cover.jpg"></div><div class="desc">A sample.</div><div class="mgen"><a href="/genre/action">Action</a></div><div class="tsinfo"><div class="imptdt">Status <i>Ongoing</i></div></div><div id="chapterlist"><ul><li><div class="eph-num"><a href="/manga/sample/chapter-1"><span class="chapternum">Chapter 1</span><span class="chapterdate">2024-01-01</span></a></div></li></ul></div></div>"#;
...
mod tests {
    ...
    #[test]
    fn parses_themesia_shapes() {
        assert_eq!(parse_listing(LIST_FIXTURE).entries[0].title, "Sample Shojo");
