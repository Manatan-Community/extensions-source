...
const SOURCE: Glowi = Glowi;
const BASE_URL: &str = "https://capibaratraductor.com/glowi";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "glowi";
const NAME: &str = "Glowi";
const LANG: &str = "es";
