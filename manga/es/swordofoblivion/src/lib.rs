...
const SOURCE: SwordOfOblivion = SwordOfOblivion;

struct SwordOfOblivion;

impl MangaSource for SwordOfOblivion {
...
fn config() -> MadaraConfig {
    MadaraConfig {
        base_url: "https://swordofoblivion.com",
        lang: "es",
        content_rating: "safe",
        manga_path: "manga",
...
<div class="summary__content"><p>Summary.</p></div>
