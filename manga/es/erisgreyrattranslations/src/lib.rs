...
const SOURCE: ErisGreyratTranslations = ErisGreyratTranslations;
const BASE_URL: &str = "https://capibaratraductor.com/erisgreyrattranslations";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "erisgreyrattranslations";

struct ErisGreyratTranslations;

impl MangaSource for ErisGreyratTranslations {
