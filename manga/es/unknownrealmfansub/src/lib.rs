...
const BASE_URL: &str = "https://capibaratraductor.com/unknown-realm-fansub";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "unknown-realm-fansub";
const NAME: &str = "Virreinato de Unknown Realm Fansub";
const LANG: &str = "es";
