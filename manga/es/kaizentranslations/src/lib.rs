...
const SOURCE: KaizenTranslations = KaizenTranslations;
const BASE_URL: &str = "https://capibaratraductor.com/kaizen";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "kaizen";

struct KaizenTranslations;

impl MangaSource for KaizenTranslations {
