...
const SOURCE: DalethProject = DalethProject;
const BASE_URL: &str = "https://capibaratraductor.com/nameless";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "nameless";

struct DalethProject;

impl MangaSource for DalethProject {
