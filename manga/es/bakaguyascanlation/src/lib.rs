...
const SOURCE: BakaguyaScanlation = BakaguyaScanlation;
const BASE_URL: &str = "https://capibaratraductor.com/bakaguya";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "bakaguya";
const NAME: &str = "Bakaguya Scanlation";
const LANG: &str = "es";
const CONTENT_RATING: &str = "safe";
const PAGE_LIMIT: u64 = 36;

struct BakaguyaScanlation;

impl MangaSource for BakaguyaScanlation {
