...
const SOURCE: AlphaCentauri = AlphaCentauri;
const BASE_URL: &str = "https://capibaratraductor.com/alphacentauri";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "alphacentauri";
const NAME: &str = "Alpha Centauri";
const LANG: &str = "es";
const CONTENT_RATING: &str = "safe";
const PAGE_LIMIT: u64 = 36;

struct AlphaCentauri;

impl MangaSource for AlphaCentauri {
