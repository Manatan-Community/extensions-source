...
const SOURCE: DoragonNoTensei = DoragonNoTensei;
const BASE_URL: &str = "https://capibaratraductor.com/dnt";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "dnt";

struct DoragonNoTensei;

impl MangaSource for DoragonNoTensei {
