...
const SOURCE: MangaMukai = MangaMukai;
const BASE_URL: &str = "https://mangamukai.com";
const SOURCE_NAME: &str = "Manga Mukai";
const LANG: &str = "es";
const CONTENT_RATING: &str = "adult";

struct MangaMukai;

impl MangaSource for MangaMukai {
...
const LIST_FIXTURE: &str = r#"<div class="bsx"><a href="/manga/sample" title="Sample Manga Mukai"><img src="/cover.jpg"></a></div><div class="pagination"><a class="next">next</a></div>"#;
const DETAILS_FIXTURE: &str = r#"
<h1 class="entry-title">Sample Manga Mukai</h1><div class="thumb"><img src="/cover.jpg"></div><div class="desc">A sample.</div>
