...
const SOURCE: AmeFansub = AmeFansub;
const BASE_URL: &str = "https://capibaratraductor.com/ame";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "ame";
const NAME: &str = "Ame Fansub";
const LANG: &str = "es";
...
impl MangaSource for AmeFansub {
