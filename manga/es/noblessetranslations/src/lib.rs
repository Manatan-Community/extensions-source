...
const SOURCE: NoblesseTranslations = NoblesseTranslations;
const BASE_URL: &str = "https://nobledicion.yoveo.xyz";

struct NoblesseTranslations;

impl MangaSource for NoblesseTranslations {
