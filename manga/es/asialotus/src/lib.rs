...
const SOURCE: AsiaLotus = AsiaLotus;
const BASE_URL: &str = "https://asialotuss.com";

struct AsiaLotus;

impl MangaSource for AsiaLotus {
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::text_between(body, "<h1", "</h1>")
            ...
            .unwrap_or_else(|| "Asia Lotus".to_string()),
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/manga/sample"><img title="Sample Asia Lotus" src="/cover.jpg"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample Asia Lotus</h1><img alt="poster" src="/cover.jpg"><div class="comic-content mobile">A sample.</div>
