...
const SOURCE: BokugenTranslation = BokugenTranslation;
const BASE_URL: &str = "https://bokugents.com";

struct BokugenTranslation;

impl MangaSource for BokugenTranslation {
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::text_between(body, "<h1", "</h1>")
            ...
            .unwrap_or_else(|| "BokugenTranslation".to_string()),
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/manga/sample"><img title="Sample BokugenTranslation" src="/cover.jpg"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample BokugenTranslation</h1><img alt="poster" src="/cover.jpg"><div class="comic-content mobile">A sample.</div>
