...
const SOURCE: LimboScanlation = LimboScanlation;
const BASE_URL: &str = "https://capibaratraductor.com/limbo";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "limbo";
const NAME: &str = "Limbo Scanlation";
const LANG: &str = "es";
const CONTENT_RATING: &str = "safe";
const PAGE_LIMIT: u64 = 36;

struct LimboScanlation;

impl MangaSource for LimboScanlation {
    ...
    root.get("data")
        ...
        .filter_map(|chapter| {
            ...
            Some(MangaChapter {
                ...
                date_uploaded: string_value(chapter, "releasedAt")
