...
const SOURCE: KawaragiNoFansub = KawaragiNoFansub;
const BASE_URL: &str = "https://capibaratraductor.com/kawaraginofansub";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "kawaraginofansub";

struct KawaragiNoFansub;

impl MangaSource for KawaragiNoFansub {
