...
const SOURCE: DapRob = DapRob;
const BASE_URL: &str = "https://daprob.com";

struct DapRob;

impl MangaSource for DapRob {
...
const LIST_FIXTURE: &str = r#"<div class="page-item-detail"><div class="post-title"><h3><a href="https://daprob.com/manga/sample">Sample</a></h3></div><img src="https://daprob.com/sample.jpg"></div><div class="nav-previous"></div>"#;
const DETAILS_FIXTURE: &str = r#"<div class="post-title"><h1>Sample</h1></div><div class="summary_image"><img src="https://daprob.com/sample.jpg"></div><li class="wp-manga-chapter"><a href="https://daprob.com/manga/sample/chapter-1">Chapter 1</a></li>"#;
const PAGES_FIXTURE: &str = r#"<div class="reading-content"><img class="wp-manga-chapter-img" src="https://daprob.com/page-1.jpg"></div>"#;
