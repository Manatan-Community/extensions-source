...
const SOURCE: Marmota = Marmota;

struct Marmota;

impl MangaSource for Marmota {
...
<div class="page-item-detail"><h3 class="post-title"><a href="/comic/sample/">Sample Comic</a></h3><img src="/cover.jpg"></div>
<div class="nav-previous"></div>
"#;
const DETAILS_FIXTURE: &str = r#"
<h1 class="post-title">Sample Comic</h1><div class="summary_image"><img src="/cover.jpg"></div>
<ul><li class="wp-manga-chapter"><a href="/comic/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">2024-01-01</span></li></ul>
"#;
