...
const SOURCE: FaxxTraduce = FaxxTraduce;
const BASE_URL: &str = "https://capibaratraductor.com/faxxtraduce";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "faxxtraduce";
const NAME: &str = "FaxxTraduce";
const LANG: &str = "es";
...
impl MangaSource for FaxxTraduce {
