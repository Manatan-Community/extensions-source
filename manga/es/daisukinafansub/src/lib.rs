...
const SOURCE: DaisukiNaFansub = DaisukiNaFansub;
const BASE_URL: &str = "https://capibaratraductor.com/dnfansub";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "dnfansub";

struct DaisukiNaFansub;

impl MangaSource for DaisukiNaFansub {
