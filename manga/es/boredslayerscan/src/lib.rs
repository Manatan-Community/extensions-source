...
const SOURCE: BoredSlayerScan = BoredSlayerScan;
const BASE_URL: &str = "https://capibaratraductor.com/boredslayerscan";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "boredslayerscan";

struct BoredSlayerScan;

impl MangaSource for BoredSlayerScan {
