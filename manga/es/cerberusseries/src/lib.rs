...
const SOURCE: CerberusSeries = CerberusSeries;
const BASE_URL: &str = "https://legionscans.com/wp";
const ORIGIN_URL: &str = "https://legionscans.com";
const SOURCE_NAME: &str = "Cerberus Series";
const CONTENT_RATING: &str = "safe";

struct CerberusSeries;

impl MangaSource for CerberusSeries {
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/wp/series/sample"><img title="Sample Cerberus Series" src="/wp/cover.jpg"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample Cerberus Series</h1><img alt="poster" src="/wp/cover.jpg"><div class="comic-content mobile">A sample.</div>
<div>Genres</div><div><a href="/wp/genres/action">Action</a></div><div>Status</div><div>Ongoing</div>
<div class="chapter-items"><a href="/wp/series/sample/chapter-1"><div class="text-sm text-white">Chapter 1</div></a></div>
"#;
const PAGES_FIXTURE: &str = r#"<div class="reading-content"><img class="object-cover mx-auto" src="/wp/page1.jpg"><img class="object-cover mx-auto" src="/wp/page2.jpg"></div>"#;
