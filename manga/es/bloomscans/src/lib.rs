...
const SOURCE: BloomScans = BloomScans;
const BASE_URL: &str = "https://bloomscans.com";

struct BloomScans;

impl MangaSource for BloomScans {
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::text_between(body, "<h1", "</h1>")
            ...
            .unwrap_or_else(|| "Bloom Scans".to_string()),
...
fn parse_pages(body: &str) -> Vec<MangaPage> {
    body.split("<img")
        .skip(1)
        .filter(|chunk| chunk.contains("object-cover") || chunk.contains("mx-auto"))
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/series/sample"><img title="Sample Bloom Scans" src="/cover.jpg"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample Bloom Scans</h1><img alt="poster" src="/cover.jpg"><div class="comic-content mobile">A sample.</div>
<div>Genres</div><div><a href="/genres/action">Action</a></div><div>Status</div><div>Ongoing</div>
<div class="chapter-items"><a href="/series/sample/chapter-1"><div class="text-sm text-white">Chapter 1</div></a></div>
"#;
const PAGES_FIXTURE: &str = r#"<div><img class="object-cover mx-auto" src="/page1.jpg"><img class="object-cover mx-auto" src="/page2.jpg"></div>"#;
