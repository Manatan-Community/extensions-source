...
const SOURCE: SweetIceCream = SweetIceCream;
const BASE_URL: &str = "https://capibaratraductor.com/sweeticecream";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "sweeticecream";
const NAME: &str = "Sweet Ice Cream";
const LANG: &str = "es";
const CONTENT_RATING: &str = "adult";
const PAGE_LIMIT: u64 = 36;

struct SweetIceCream;

impl MangaSource for SweetIceCream {
...
fn pages_api_url(key: &str) -> String {
    ...
    format!(
        "{API_BASE_URL}/api/manga-custom/{}/chapter/{chapter}/pages",
        normalize_slug(slug)
    )
}
