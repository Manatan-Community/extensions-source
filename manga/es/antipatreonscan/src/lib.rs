...
const SOURCE: AntipatreonScan = AntipatreonScan;
const BASE_URL: &str = "https://capibaratraductor.com/antipatreon";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "antipatreon";
const NAME: &str = "AntiPatreon Scan";
const LANG: &str = "es";
const CONTENT_RATING: &str = "safe";
const PAGE_LIMIT: u64 = 36;

struct AntipatreonScan;

impl MangaSource for AntipatreonScan {
