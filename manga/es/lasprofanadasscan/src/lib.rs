...
const SOURCE: LasProfanadasScan = LasProfanadasScan;
const BASE_URL: &str = "https://capibaratraductor.com/profanadasscan";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "profanadasscan";
const NAME: &str = "Las Profanadas Scan";
const LANG: &str = "es";
const CONTENT_RATING: &str = "adult";
const PAGE_LIMIT: u64 = 36;

struct LasProfanadasScan;

impl MangaSource for LasProfanadasScan {
