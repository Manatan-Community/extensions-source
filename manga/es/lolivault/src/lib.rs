...
const SOURCE: Lolivault = Lolivault;
const BASE_URL: &str = "https://lector.lolivault.net";
const SOURCE_NAME: &str = "Lolivault";

struct Lolivault;

impl MangaSource for Lolivault {
...
<div class="group"><a href="https://lector.lolivault.net/series/cell/"><img class="preview" src="/cover.png" /></a><div class="title"><a href="https://lector.lolivault.net/series/cell/" title="CELL">CELL</a></div></div>
"#;
const DETAILS_FIXTURE: &str = r#"
<div class="large comic"><img src="/cover.png" /><h1 class="title">CELL</h1></div>
<div class="element"><div class="title"><a href="https://lector.lolivault.net/read/cell/en/0/71/" title="Chapter 71: Afterword">Chapter 71: Afterword</a></div><div class="meta_r">by <a href="/team/death_toll_scans/" title="Lolivault">Lolivault</a>, 2024.04.19</div></div>
"#;
