...
const SOURCE: KingdomDarkScan = KingdomDarkScan;
const BASE_URL: &str = "https://capibaratraductor.com/kingdomdarkscan";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "kingdomdarkscan";

struct KingdomDarkScan;

impl MangaSource for KingdomDarkScan {
