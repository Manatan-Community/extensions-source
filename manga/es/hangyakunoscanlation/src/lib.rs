...
const SOURCE: HangyakuNoScanlation = HangyakuNoScanlation;
const BASE_URL: &str = "https://capibaratraductor.com/hangyakunoscanlation";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "hangyakunoscanlation";

struct HangyakuNoScanlation;

impl MangaSource for HangyakuNoScanlation {
