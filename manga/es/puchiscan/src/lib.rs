...
const SOURCE: PuchiScan = PuchiScan;
const BASE_URL: &str = "https://capibaratraductor.com/puchi";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "puchi";
const NAME: &str = "PuchiScan";
const LANG: &str = "es";
...
impl MangaSource for PuchiScan {
