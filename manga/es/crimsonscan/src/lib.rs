...
const SOURCE: CrimsonScan = CrimsonScan;
const BASE_URL: &str = "https://capibaratraductor.com/crimsonscan";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "crimsonscan";

struct CrimsonScan;

impl MangaSource for CrimsonScan {
