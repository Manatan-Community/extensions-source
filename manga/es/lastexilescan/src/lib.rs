...
const SOURCE: LastExileScan = LastExileScan;
const BASE_URL: &str = "https://capibaratraductor.com/lastexilescan";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "lastexilescan";
const NAME: &str = "Last Exile Scan";
const LANG: &str = "es";
const CONTENT_RATING: &str = "safe";
const PAGE_LIMIT: u64 = 36;

struct LastExileScan;

impl MangaSource for LastExileScan {
