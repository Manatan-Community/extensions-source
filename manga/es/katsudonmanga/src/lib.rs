...
const SOURCE: KatsudonManga = KatsudonManga;
const BASE_URL: &str = "https://capibaratraductor.com/katsudonmanga";
const API_URL: &str = "https://capibaratraductor.com";
const ORG: &str = "katsudonmanga";

struct KatsudonManga;

impl MangaSource for KatsudonManga {
