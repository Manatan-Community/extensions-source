...
const SOURCE: MangaRomance = MangaRomance;

struct MangaRomance;

impl MangaSource for MangaRomance {
    ...
    fn chapters(&self, request: Value) -> ExtensionResult<Vec<MangaChapter>> {
        ...
        let body =
            manga::Madara::fetch_document_or_fixture(&config, &config.absolute_url(&key), DETAILS_FIXTURE);
        let chapters = fetch_new_endpoint_chapters(&key, &config);
...
fn config() -> MadaraConfig {
    MadaraConfig {
        base_url: "https://mangaromance19.com",
        lang: "es",
...
<div class="page-item-detail"><h3 class="post-title"><a href="/manga/sample/">Sample Romance</a></h3><img src="/cover.jpg"></div>
<div class="nav-previous"></div>
"#;
const DETAILS_FIXTURE: &str = r#"
<div class="post-title"><h1>Sample Romance</h1></div><div class="summary_image"><img src="/cover.jpg"></div>
<ul><li class="wp-manga-chapter"><a href="/manga/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">01 enero, 2024</span></li></ul>
"#;
