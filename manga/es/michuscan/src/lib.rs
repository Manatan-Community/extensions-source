...
const SOURCE: MichuScan = MichuScan;
const BASE_URL: &str = "https://capibaratraductor.com/michuscan";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "michuscan";
const NAME: &str = "Michu Scan";
const LANG: &str = "es";
...
impl MangaSource for MichuScan {
