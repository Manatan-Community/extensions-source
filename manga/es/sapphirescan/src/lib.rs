...
const SOURCE: SapphireScan = SapphireScan;
const BASE_URL: &str = "https://www.sapphirescan.com";
const NAME: &str = "SapphireScan";
const LANG: &str = "es";
...
impl MangaSource for SapphireScan {
...
fn parse_pages(body: &str) -> Vec<MangaPage> {
    let reader_body = body.split("check-box").nth(1).unwrap_or(body);
    reader_body
        .split("<img")
        .skip(1)
        .filter_map(|chunk| {
...
const LIST_FIXTURE: &str = r#"{"feed":{"entry":[{"title":{"$t":"Sample"},"category":[{"term":"Series"}],"link":[{"rel":"alternate","href":"https://www.sapphirescan.com/p/sample.html"}],"media$thumbnail":{"url":"https://1.bp.blogspot.com/s72-c/sample.jpg"}}]}}"#;
...
const CHAPTERS_FIXTURE: &str = r#"{"feed":{"entry":[{"title":{"$t":"Capitulo 1"},"published":{"$t":"2024-01-01T00:00:00.000Z"},"category":[{"term":"Chapter"}],"link":[{"rel":"alternate","href":"https://www.sapphirescan.com/2024/01/sample.html"}]}]}}"#;
