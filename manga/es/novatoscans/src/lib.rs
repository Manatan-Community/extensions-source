...
const SOURCE: NovatoScans = NovatoScans;
const BASE_URL: &str = "https://www.novatoscans.top";
const NAME: &str = "Novato Scans";
const LANG: &str = "es";
...
impl MangaSource for NovatoScans {
...
const LIST_FIXTURE: &str = r#"{"feed":{"entry":[{"title":{"$t":"Sample"},"category":[{"term":"Series"}],"link":[{"rel":"alternate","href":"https://www.novatoscans.top/p/sample.html"}],"media$thumbnail":{"url":"https://1.bp.blogspot.com/s72-c/sample.jpg"}}]}}"#;
...
const CHAPTERS_FIXTURE: &str = r#"{"feed":{"entry":[{"title":{"$t":"Capitulo 1"},"published":{"$t":"2024-01-01T00:00:00.000Z"},"category":[{"term":"Chapter"}],"link":[{"rel":"alternate","href":"https://www.novatoscans.top/2024/01/sample.html"}]}]}}"#;
