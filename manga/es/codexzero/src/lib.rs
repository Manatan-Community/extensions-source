...
const SOURCE: CodexZero = CodexZero;
const BASE_URL: &str = "https://codex.readkisho.me";

struct CodexZero;

impl MangaSource for CodexZero {
...
const LIST_FIXTURE: &str = r#"<div class="page-item-detail"><div class="post-title"><h3><a href="https://codex.readkisho.me/manga/sample">Sample</a></h3></div><img src="https://codex.readkisho.me/sample.jpg"></div>"#;
const DETAILS_FIXTURE: &str = r#"<div class="post-title"><h1>Sample</h1></div><div class="summary_image"><img src="https://codex.readkisho.me/sample.jpg"></div><li class="wp-manga-chapter"><a href="https://codex.readkisho.me/manga/sample/chapter-1">Chapter 1</a></li>"#;
const PAGES_FIXTURE: &str = r#"<div class="reading-content"><img class="wp-manga-chapter-img" src="https://codex.readkisho.me/page-1.jpg"></div>"#;
