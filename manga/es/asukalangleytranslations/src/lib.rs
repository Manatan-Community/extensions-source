...
const SOURCE: AsukaLangleyTranslations = AsukaLangleyTranslations;
const BASE_URL: &str = "https://capibaratraductor.com/asukatranslations";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "asukatranslations";
const NAME: &str = "Asuka Langley Translations";
const LANG: &str = "es";
const CONTENT_RATING: &str = "safe";
const PAGE_LIMIT: u64 = 36;

struct AsukaLangleyTranslations;

impl MangaSource for AsukaLangleyTranslations {
