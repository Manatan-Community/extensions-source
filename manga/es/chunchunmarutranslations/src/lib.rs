...
const SOURCE: ChunchunmaruTranslations = ChunchunmaruTranslations;
const BASE_URL: &str = "https://capibaratraductor.com/chunchunmarutl";
const API_BASE_URL: &str = "https://capibaratraductor.com";
const ORGANIZATION: &str = "chunchunmarutl";
const NAME: &str = "Chunchunmaru Translations";
const LANG: &str = "es";
const CONTENT_RATING: &str = "safe";
const PAGE_LIMIT: u64 = 36;

struct ChunchunmaruTranslations;

impl MangaSource for ChunchunmaruTranslations {
