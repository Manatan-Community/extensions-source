...
const SOURCE: EmperorScan = EmperorScan;
const BASE_URL: &str = "https://imperiomanhua.com";

struct EmperorScan;

impl MangaSource for EmperorScan {
...
fn parse_details(body: &str, key: Option<String>, config: &MadaraConfig) -> CatalogItem {
    ...
    if let Some(description) = sinopsis_description(body) {
        item.description = Some(description);
    }
    item
}

fn sinopsis_description(body: &str) -> Option<String> {
    let chunk = body
        .split("post-content_item")
        .find(|chunk| chunk.contains("Sinopsis"))?;
    let after_heading = chunk
        .find("</h5>")
        .map(|index| &chunk[index + "</h5>".len()..])
        .unwrap_or(chunk);
    html::text_between(after_heading, "<div", "</div>")
...
const LIST_FIXTURE: &str = r#"<div class="page-item-detail"><div class="post-title"><h3><a href="https://imperiomanhua.com/manga/sample">Sample</a></h3></div><img src="https://imperiomanhua.com/sample.jpg"></div><div class="nav-previous"></div>"#;
const DETAILS_FIXTURE: &str = r#"<div class="post-title"><h1>Sample</h1></div><div class="summary_image"><img src="https://imperiomanhua.com/sample.jpg"></div><div class="summary_content"><div class="post-content_item"><h5>Sinopsis</h5><div>Custom summary</div></div></div><li class="wp-manga-chapter"><a href="https://imperiomanhua.com/manga/sample/chapter-1">Chapter 1</a></li>"#;
const PAGES_FIXTURE: &str = r#"<div class="reading-content"><img class="wp-manga-chapter-img" src="https://imperiomanhua.com/page-1.jpg"></div>"#;
