...
const SOURCE: Manhwa18Org = Manhwa18Org;

struct Manhwa18Org;

impl MangaSource for Manhwa18Org {
...
const DETAILS_FIXTURE: &str = r#"<div class="post-title"><h1>Sample Manga</h1></div><div class="summary_image"><img src="/cover.jpg"></div><ul class="main version-chap"><li class="wp-manga-chapter"><a href="/manga/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">2024-01-01</span></li><li class="wp-manga-chapter"><span class="locked-badge"></span><a href="/manga/sample/premium/">Premium</a></li></ul>"#;
