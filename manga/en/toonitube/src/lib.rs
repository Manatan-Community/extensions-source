...
const SOURCE: TooniTube = TooniTube;
const BASE_URL: &str = "https://toonitube.com";
const SOURCE_NAME: &str = "TooniTube";

struct TooniTube;

impl MangaSource for TooniTube {
...
<div class="book-detailed-item"><a href="/manga/123-sample" title="Sample TooniTube"><img data-src="/cover.jpg"></a><div class="summary">Summary.</div><div class="genres"><a>Action</a></div></div>
"#;
const DETAILS_FIXTURE: &str = r#"
<div class="detail"><h1>Sample TooniTube</h1><h2>Alt Sample</h2><div id="cover"><img data-src="/cover.jpg"></div>
