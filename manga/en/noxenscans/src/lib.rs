...
const SOURCE: NoxenScans = NoxenScans;
const BASE_URL: &str = "https://noxenscan.com";
const SOURCE_NAME: &str = "Noxen Scans";

struct NoxenScans;

impl MangaSource for NoxenScans {
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/manga/sample"><img title="Sample Noxen Scans" src="/cover.jpg"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample Noxen Scans</h1><img alt="poster" src="/cover.jpg"><div class="comic-content mobile">A sample.</div>
