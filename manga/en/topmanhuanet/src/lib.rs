...
const SOURCE: TopManhuaNet = TopManhuaNet;
const CONFIG: MadaraConfig = MadaraConfig {
    base_url: "https://topmanhua.net",
    lang: "en",
    content_rating: "safe",
    manga_path: "manga",
...
impl MangaSource for TopManhuaNet {
...
const DETAILS_FIXTURE: &str = r#"<h1 class="post-title">Sample</h1><div class="summary_image"><img src="/cover.jpg"></div><div class="description-summary">Summary</div><li class="wp-manga-chapter"><a href="/manga/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">2024-01-01</span></li>"#;
