...
const SOURCE: MadaraDex = MadaraDex;

struct MadaraDex;

impl MangaSource for MadaraDex {
...
<div class="page-item-detail"><h3 class="post-title"><a href="/title/sample/">Sample Manga</a></h3><img src="/cover.jpg"></div>
<div class="nav-previous"></div>
"#;
const DETAILS_FIXTURE: &str = r#"
<div class="post-title"><h1>Sample Manga</h1></div><div class="summary_image"><img src="/cover.jpg"></div>
<ul class="main version-chap"><li class="wp-manga-chapter"><a href="/title/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">Jan 1, 2024</span></li></ul>
"#;
