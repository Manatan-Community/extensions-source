...
const SOURCE: MangaPandaOnl = MangaPandaOnl;
const BASE_URL: &str = "https://mangapanda.onl";
...
const MANGA_SOURCE: &str = "mr02";
const CONTENT_RATING: &str = "adult";

struct MangaPandaOnl;

impl MangaSource for MangaPandaOnl {
