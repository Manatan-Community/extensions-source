...
const SOURCE: NikaToons = NikaToons;
const BASE_URL: &str = "https://nikatoons.com";

struct NikaToons;

impl MangaSource for NikaToons {
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::text_between(body, "<h1", "</h1>")
            ...
            .unwrap_or_else(|| "NikaToons".to_string()),
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/manga/sample"><img title="Sample NikaToons" src="/cover.jpg"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample NikaToons</h1><img alt="poster" src="/cover.jpg"><div class="comic-content mobile">A sample.</div>
