...
const SOURCE: MangakakalotFun = MangakakalotFun;
const BASE_URL: &str = "https://mangakakalot.fun";
...
const MANGA_SOURCE: &str = "mn01";
const CONTENT_RATING: &str = "adult";

struct MangakakalotFun;

impl MangaSource for MangakakalotFun {
