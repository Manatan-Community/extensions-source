...
const SOURCE: TCBScansUnoriginal = TCBScansUnoriginal;
const BASE_URL: &str = "https://tcbscanonepiecechapters.com";

struct TCBScansUnoriginal;

impl MangaSource for TCBScansUnoriginal {
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::text_between(body, "<h1", "</h1>")
            ...
            .unwrap_or_else(|| "TCB Scans (Unoriginal)".to_string()),
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/manga/sample"><img title="Sample TCB Scans (Unoriginal)" src="/cover.jpg"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample TCB Scans (Unoriginal)</h1><img alt="poster" src="/cover.jpg"><div class="comic-content mobile">A sample.</div>
