...
const SOURCE: ReadSoloLevelingMangaManhwaOnline = ReadSoloLevelingMangaManhwaOnline;
const BASE_URL: &str = "https://ww3.readsololeveling.org";
const OPM_LAYOUT: bool = false;
const SOURCE_LIST: &[(&str, &str)] = &[
    ("Solo Leveling Manhwa", "/manga/solo-leveling/"),
    (
        "Solo Leveling Light Novel",
        "/manga/solo-leveling-light-novel/",
    ),
    ("Solo Leveling : Ragnarok", "/manga/solo-leveling-ragnarok/"),
    ("SL: Ragnarok Novel", "/manga/solo-leveling-ragnarok-novel/"),
];

struct ReadSoloLevelingMangaManhwaOnline;

impl MangaSource for ReadSoloLevelingMangaManhwaOnline {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        let key = manga::request_key(&request, "chapter")
            .unwrap_or_else(|| "/chapter/solo-leveling-chapter-1/".to_string());
...
<div class="container"><h1>Solo Leveling Manhwa</h1></div>
<div class="flex"><img src="/cover.png"></div>
<div>Description</div><div>Sung Jinwoo enters a dangerous dungeon.</div>
<div class="col-span-4"><a href="https://ww3.readsololeveling.org/chapter/solo-leveling-chapter-1/">Chapter 1</a></div>
"#;

const PAGES_FIXTURE: &str = r#"
<div class="js-pages-container">
<img data-src="https://ww3.readsololeveling.org/file/sample/1.jpeg" class="js-page">
<img data-src="https://ww3.readsololeveling.org/file/sample/2.jpeg" class="js-page">
</div>
"#;
