...
const SOURCE: KenScans = KenScans;
const BASE_URL: &str = "https://kencomics.com";
const API_URL: &str = "https://api.kencomics.com";
const PER_PAGE: u64 = 18;

struct KenScans;

impl MangaSource for KenScans {
...
const SEARCH_FIXTURE: &str = r#"{
  "posts": [{
    ...
    "isNovel": false,
    "featuredImage": "https://kencomics.com/cover.jpg",
...
const PAGES_FIXTURE: &str = r#"{
  "chapter": {
    "images": [{ "url": "https://kencomics.com/page 1.jpg", "order": 1 }],
