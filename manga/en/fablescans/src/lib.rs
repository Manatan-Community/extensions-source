...
const SOURCE: FableScans = FableScans;

struct FableScans;

impl MangaSource for FableScans {
...
<ul class="main version-chap"><li class="wp-manga-chapter"><a href="/comic/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">2024-01-01</span></li></ul>
"#;
