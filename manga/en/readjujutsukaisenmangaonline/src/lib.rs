...
const SOURCE: ReadJujutsuKaisenMangaOnline = ReadJujutsuKaisenMangaOnline;
const BASE_URL: &str = "https://ww5.readjujutsukaisen.com";
const NAME: &str = "Read Jujutsu Kaisen Manga Online";

struct ReadJujutsuKaisenMangaOnline;

impl MangaSource for ReadJujutsuKaisenMangaOnline {
