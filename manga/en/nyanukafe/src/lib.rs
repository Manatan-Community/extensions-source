...
const SOURCE: NyanuKafe = NyanuKafe;
const BASE_URL: &str = "https://nyanukafe.com";

struct NyanuKafe;

impl MangaSource for NyanuKafe {
    ...
    body.split('<')
        ...
        .filter_map(|chunk| {
            ...
            let title = html::attr(chunk, "title")
                ...
                .unwrap_or_else(|| "Nyanu Kafe".to_string());
...
<button href="/series/sample" title="Sample Nyanu Kafe" style="background-image:url('https://cdn.keyoapp.com/cover.jpg')"></button>
"#;
