...
const SOURCE: OrionScans = OrionScans;
const BASE_URL: &str = "https://orion-scans.com";
const API_URL: &str = BASE_URL;
const PER_PAGE: u64 = 18;

struct OrionScans;

impl MangaSource for OrionScans {
...
const SEARCH_FIXTURE: &str = r#"{
  "posts": [{
    ...
    "isNovel": false,
    "featuredImage": "https://orionscans.com/cover.jpg",
...
const PAGES_FIXTURE: &str = r#"{
  "chapter": {
    "images": [{ "url": "https://orionscans.com/page 1.jpg", "order": 1 }],
