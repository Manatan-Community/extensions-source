...
const SOURCE: Mangaforfreecom = Mangaforfreecom;
...
struct Mangaforfreecom;

impl MangaSource for Mangaforfreecom {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        ...
        let mut pages = manga::Madara::parse_pages(
...
const LIST_FIXTURE: &str = r#"<div class="page-item-detail"><a class="post-title" href="https://mangaforfree.com/manga/sample/">Sample</a><img src="/cover.jpg"></div><div class="nav-previous"></div>"#;
const DETAILS_FIXTURE: &str = r#"<h1>Sample</h1><div class="summary_image"><img src="/cover.jpg"></div><div class="description-summary">Summary</div><li class="wp-manga-chapter"><a href="https://mangaforfree.com/manga/sample/chapter-1/">Chapter 1</a></li>"#;
const PAGES_FIXTURE: &str = r#"<div class="reading-content"><img class="wp-manga-chapter-img" src="http://mangaforfree.com/page1.jpg"></div>"#;
