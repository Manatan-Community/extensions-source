...
const SOURCE: ReadFairyTailEdensZeroMangaOnline = ReadFairyTailEdensZeroMangaOnline;
const BASE_URL: &str = "https://ww8.readfairytail.com";
const NAME: &str = "Read Fairy Tail & Edens Zero Manga Online";

struct ReadFairyTailEdensZeroMangaOnline;

impl MangaSource for ReadFairyTailEdensZeroMangaOnline {
...
fn details_from(body: &str) -> CatalogItem {
    CatalogItem {
        key: BASE_URL.to_string(),
        title: html::text_between(body, "div.container > h1", "</")
