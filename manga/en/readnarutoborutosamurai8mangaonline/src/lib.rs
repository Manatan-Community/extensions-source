...
const SOURCE: ReadNarutoBorutoSamurai8MangaOnline = ReadNarutoBorutoSamurai8MangaOnline;
const BASE_URL: &str = "https://ww11.readnaruto.com";
const OPM_LAYOUT: bool = false;
const SOURCE_LIST: &[(&str, &str)] = &[
    ("Boruto - Two Blue Vortex", "/manga/boruto-two-blue-vortex/"),
    ("Naruto", "/manga/naruto/"),
    ("Naruto Colored", "/manga/naruto-digital-colored-comics/"),
    ("Naruto Gaiden", "/manga/naruto-gaiden-the-seventh-hokage/"),
    ("Boruto", "/manga/boruto-naruto-next-generations/"),
    ("Samurai 8", "/manga/samurai-8-hachimaru-den/"),
    (
        "Rock Lee SpinOff",
        "/manga/rock-lee-no-seishun-full-power-ninden/",
    ),
    ("Chibi Sasuke", "/manga/uchiha-sasuke-no-sharingan-den/"),
    (
        "Sasuke Story",
        "/manga/naruto-sasuke-retsuden-uchiha-no-matsuei-to-tenkyuu-no-hoshikuzu/",
    ),
];

struct ReadNarutoBorutoSamurai8MangaOnline;

impl MangaSource for ReadNarutoBorutoSamurai8MangaOnline {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        let key = manga::request_key(&request, "chapter")
            .unwrap_or_else(|| "/chapter/naruto-chapter-1/".to_string());
...
<div class="container"><h1>Boruto - Two Blue Vortex</h1></div>
<div class="flex"><img src="/cover.png"></div>
<div>Description</div><div>Naruto franchise manga chapters.</div>
<div class="col-span-4"><a href="https://ww11.readnaruto.com/chapter/naruto-chapter-1/">Chapter 1</a></div>
"#;

const PAGES_FIXTURE: &str = r#"
<div class="js-pages-container">
<img data-src="https://ww11.readnaruto.com/file/sample/1.jpeg" class="js-page">
<img data-src="https://ww11.readnaruto.com/file/sample/2.jpeg" class="js-page">
</div>
"#;
