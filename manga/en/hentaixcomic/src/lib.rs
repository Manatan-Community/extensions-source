...
const SOURCE: HentaiXComic = HentaiXComic;

struct HentaiXComic;

impl MangaSource for HentaiXComic {
...
fn config() -> MadaraConfig {
    MadaraConfig {
        base_url: "https://hentaixcomic.com",
        lang: "en",
...
<ul class="main version-chap"><li class="wp-manga-chapter"><a href="/manga/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">Jan 1, 2024</span></li></ul>
"#;
