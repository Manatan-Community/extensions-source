...
const SOURCE: HadesScans = HadesScans;
const BASE_URL: &str = "https://hadesscans.com";

struct HadesScans;

impl MangaSource for HadesScans {
        ...
        .filter_map(|chunk| {
            ...
            Some(CatalogItem {
                ...
                title: html::text_between(chunk, "card-v-title", "</")
                    ...
                    .unwrap_or_else(|| {
                        url::slug_from_url(&key).unwrap_or_else(|| "Hades Scans".into())
                    }),
