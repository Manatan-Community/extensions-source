...
const SOURCE: Razure = Razure;
const BASE_URL: &str = "https://razure.org";

struct Razure;

impl MangaSource for Razure {
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::text_between(body, "<h1", "</h1>")
            ...
            .unwrap_or_else(|| "Razure".to_string()),
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/manga/sample"><img title="Sample Razure" src="/cover.jpg"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample Razure</h1><img alt="poster" src="/cover.jpg"><div class="comic-content mobile">A sample.</div>
