...
const SOURCE: ArcRelight = ArcRelight;
const BASE_URL: &str = "https://arc-relight.com";
const API_URL: &str = "https://arc-relight.com/api/v2";

struct ArcRelight;

impl MangaSource for ArcRelight {
