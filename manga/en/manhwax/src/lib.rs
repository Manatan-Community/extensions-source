...
const SOURCE: Manhwax = Manhwax;
const BASE_URL: &str = "https://manhwax.top";

struct Manhwax;

impl MangaSource for Manhwax {
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::text_between(body, "<h1", "</h1>")
            ...
            .unwrap_or_else(|| "Manhwax".to_string()),
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/manga/sample"><img title="Sample Manhwax" src="/cover.jpg"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample Manhwax</h1><img alt="poster" src="/cover.jpg"><div class="comic-content mobile">A sample.</div>
