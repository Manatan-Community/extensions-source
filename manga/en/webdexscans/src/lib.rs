...
const SOURCE: WebdexScans = WebdexScans;
const CONFIG: MadaraConfig = MadaraConfig {
    base_url: "https://webdexscans.com",
    lang: "en",
    content_rating: "safe",
    manga_path: "series",
...
impl MangaSource for WebdexScans {
...
const LIST_FIXTURE: &str = r#"<div class="page-item-detail"><h3 class="post-title"><a href="/series/sample/">Sample</a></h3><img src="/cover.jpg"></div><div class="nav-previous"></div>"#;
const DETAILS_FIXTURE: &str = r#"<h1 class="post-title">Sample</h1><div class="summary_image"><img src="/cover.jpg"></div><div class="description-summary">Summary</div><li class="wp-manga-chapter"><a href="/series/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">2024-01-01</span></li>"#;
