...
const SOURCE: RitharScans = RitharScans;
const BASE_URL: &str = "https://ritharscans.com";

struct RitharScans;

impl MangaSource for RitharScans {
...
<button href="/series/sample" title="Sample Manga" style="background-image:url('https://cdn.keyoapp.com/cover.jpg')"></button>
"#;
