...
const SOURCE: RavenScans = RavenScans;
const BASE_URL: &str = "https://ravenscans.org";

struct RavenScans;

impl MangaSource for RavenScans {
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::text_between(body, "<h1", "</h1>")
            ...
            .unwrap_or_else(|| "Raven Scans".to_string()),
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/manga/sample"><img title="Sample Raven Scans" src="/cover.jpg"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample Raven Scans</h1><img alt="poster" src="/cover.jpg"><div class="comic-content mobile">A sample.</div>
