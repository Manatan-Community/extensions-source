...
const SOURCE: WitchScans = WitchScans;
const BASE_URL: &str = "https://witchscans.com";

struct WitchScans;

impl MangaSource for WitchScans {
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::text_between(body, "<h1", "</h1>")
            ...
            .unwrap_or_else(|| "WitchScans".to_string()),
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/manga/sample"><img title="Sample Witch" src="/cover.jpg"></a></div>"#;

const DETAILS_FIXTURE: &str = r#"
<h1>Sample Witch</h1><img alt="poster" src="/cover.jpg"><div class="comic-content mobile">A sample.</div>
...
mod tests {
    ...
    fn parses_themesia_source() {
        ...
        assert_eq!(listing.entries[0].title, "Sample Witch");
