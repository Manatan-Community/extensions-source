...
const SOURCE: SanaScans = SanaScans;
const BASE_URL: &str = "https://sanascans.com";
const API_URL: &str = "https://api.sanascans.com";
const PER_PAGE: u64 = 30;

struct SanaScans;

impl MangaSource for SanaScans {
...
const SEARCH_FIXTURE: &str = r#"{
  "posts": [{
    ...
    "isNovel": false,
    "featuredImage": "https://sanascans.com/cover.jpg",
...
const PAGES_FIXTURE: &str = r#"{
  "chapter": {
    "images": [{ "url": "https://sanascans.com/page 1.jpg", "order": 1 }],
