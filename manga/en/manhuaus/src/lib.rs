...
const SOURCE: ManhuaUs = ManhuaUs;
...
<div class="page-item-detail"><h3 class="post-title"><a href="/manga/sample/">Sample Manhua</a></h3><img src="/cover.jpg"></div>
<div class="nav-previous"></div>
"#;
const DETAILS_FIXTURE: &str = r#"
<div class="post-title"><h1>Sample Manhua</h1></div><div class="summary_image"><img src="/cover.jpg"></div>
