...
const SOURCE: ReadOnePunchManMangaOnlineTwo = ReadOnePunchManMangaOnlineTwo;
const BASE_URL: &str = "https://ww6.readopm.com";
const OPM_LAYOUT: bool = true;
...
struct ReadOnePunchManMangaOnlineTwo;

impl MangaSource for ReadOnePunchManMangaOnlineTwo {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        let key = manga::request_key(&request, "chapter")
            .unwrap_or_else(|| "/chapter/one-punch-man-chapter-1/".to_string());
...
<div class="card-body"><h2>Manga: <span>One Punch Man</span></h2><p>A hero removes monsters from the streets.</p></div>
<img class="card-img-right" src="/cover.png">
<tbody><tr><td>One Punch Man Chapter 1</td><td>Jan 01, 2016</td><td><a href="https://ww6.readopm.com/chapter/one-punch-man-chapter-1/">Read</a></td></tr></tbody>
"#;

const PAGES_FIXTURE: &str = r#"
<div class="js-pages-container">
<img data-src="https://ww6.readopm.com/file/sample/1.jpeg" class="js-page">
<img data-src="https://ww6.readopm.com/file/sample/2.jpeg" class="js-page">
</div>
"#;
