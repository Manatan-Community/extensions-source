...
const SOURCE: RestScans = RestScans;
const BASE_URL: &str = "https://restscans.com";

struct RestScans;

impl MangaSource for RestScans {
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::text_between(body, "<h1", "</h1>")
            ...
            .unwrap_or_else(|| "Rest Scans".to_string()),
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/manga/sample"><img title="Sample Rest Scans" src="/cover.jpg"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample Rest Scans</h1><img alt="poster" src="/cover.jpg"><div class="comic-content mobile">A sample.</div>
