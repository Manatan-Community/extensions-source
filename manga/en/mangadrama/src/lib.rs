...
const SOURCE: MangaDrama = MangaDrama;
...
impl MangaSource for MangaDrama {
    ...
    fn chapters(&self, request: Value) -> ExtensionResult<Vec<MangaChapter>> {
        ...
        chapters.retain(|chapter| !chapter.is_locked);
        Ok(chapters)
    }
...
const LIST_FIXTURE: &str = r#"<div class="page-item-detail"><a class="post-title" href="https://mangadrama.com/manga/sample/">Sample</a><img src="/cover.jpg"></div><div class="nav-previous"></div>"#;
const DETAILS_FIXTURE: &str = r#"<h1>Sample</h1><div class="summary_image"><img src="/cover.jpg"></div><div class="description-summary">Summary</div><li class="wp-manga-chapter free-chap"><a href="https://mangadrama.com/manga/sample/chapter-1/">Chapter 1</a></li>"#;
