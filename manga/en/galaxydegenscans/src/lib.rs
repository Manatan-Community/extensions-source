...
const SOURCE: GalaxyDegenScans = GalaxyDegenScans;

struct GalaxyDegenScans;

impl MangaSource for GalaxyDegenScans {
...
<ul class="main version-chap"><li class="wp-manga-chapter"><a href="/manga/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">January 1, 2024</span></li></ul>
"#;
...
mod tests {
    ...
    fn parses_madara_source() {
        ...
        assert_eq!(listing.entries[0].content_rating.as_deref(), Some("adult"));
    }
}
