...
const SOURCE: Novel24h = Novel24h;
const CONFIG: MadaraConfig = MadaraConfig {
    base_url: "https://24hnovel.com",
    lang: "en",
    ...
    fn home(&self, _request: Value) -> ExtensionResult<Vec<HomeSection<CatalogItem>>> {
        Ok(vec![
            HomeSection {
                ...
                entries: self
                    .list(serde_json::json!({"page": 1, "listingId": "popular"}))?
                    .entries,
                has_more: true,
                ..HomeSection::default()
            },
            HomeSection {
                ...
                entries: self
                    .list(serde_json::json!({"page": 1, "listingId": "latest"}))?
                    .entries,
                has_more: true,
                ..HomeSection::default()
            },
...
const DETAILS_FIXTURE: &str = r#"<h1 class="post-title">Sample</h1><div class="summary_image"><img src="/cover.jpg"></div><div class="description-summary">Summary</div><li class="wp-manga-chapter"><a href="/manga/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">01.01.2024</span></li>"#;
