...
const SOURCE: Mahouirexnohentaikarte = Mahouirexnohentaikarte;

struct Mahouirexnohentaikarte;

impl MangaSource for Mahouirexnohentaikarte {
...
fn config() -> MadaraConfig {
    MadaraConfig {
        base_url: "https://mahouirexnohentaikarte.com",
        lang: "en",
...
<ul class="main version-chap"><li class="wp-manga-chapter"><a href="/manga/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">2024-01-01</span></li><li class="wp-manga-chapter"><span class="locked-badge"></span><a href="/manga/sample/premium/">Premium</a></li></ul>
"#;
