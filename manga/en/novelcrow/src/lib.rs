...
const SOURCE: NovelCrow = NovelCrow;

struct NovelCrow;

impl MangaSource for NovelCrow {
...
fn novelcrow_list_url(page: u64, order: &str) -> String {
    let page_path = if page <= 1 {
        String::new()
    } else {
        format!("page/{page}/")
    };
    format!("https://novelcrow.com/{page_path}?s=&post_type=wp-manga&m_orderby={order}")
}

export_manga_source!(SOURCE);

const LIST_FIXTURE: &str = r#"
<div class="page-item-detail"><h3 class="post-title"><a href="/comic/sample/">Sample NovelCrow</a></h3><img src="/cover.jpg"></div>
<div class="nav-previous"></div>
"#;
const DETAILS_FIXTURE: &str = r#"
<div class="post-title"><h1>Sample NovelCrow</h1></div><div class="summary_image"><img src="/cover.jpg"></div>
<ul class="main version-chap"><li class="wp-manga-chapter"><a href="/comic/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">2024-01-01</span></li><li class="wp-manga-chapter"><span class="locked-badge"></span><a href="/comic/sample/premium/">Premium</a></li></ul>
"#;
