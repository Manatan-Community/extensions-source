...
const SOURCE: SkyManga = SkyManga;
const BASE_URL: &str = "https://skymanga.work";

struct SkyManga;

impl MangaSource for SkyManga {
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::text_between(body, "<h1", "</h1>")
            ...
            .unwrap_or_else(|| "Sky Manga".to_string()),
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/manga/sample"><img title="Sample Sky Manga" src="/cover.jpg"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"
<h1>Sample Sky Manga</h1><img alt="poster" src="/cover.jpg"><div class="comic-content mobile">A sample.</div>
