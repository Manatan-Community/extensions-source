...
const SOURCE: MangaReaderSite = MangaReaderSite;
const BASE_URL: &str = "https://mangareader.site";
...
const MANGA_SOURCE: &str = "mr01";
const CONTENT_RATING: &str = "safe";

struct MangaReaderSite;

impl MangaSource for MangaReaderSite {
...
fn graphql_or_fixture(query: &str, refresh_url: Option<&str>, fixture: &str) -> String {
    let _ = client()
        .get(refresh_url.unwrap_or(BASE_URL))
        .browser_document()
        .send_text();
    client()
        .post(API_URL)
    ...
    chapters
        ...
        .map(|chapter| {
            ...
            MangaChapter {
                ...
                date_uploaded: json_text(&chapter, "date")
