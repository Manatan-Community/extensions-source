...
const SOURCE: HentaiXYuri = HentaiXYuri;

struct HentaiXYuri;

impl MangaSource for HentaiXYuri {
    ...
    fn chapters(&self, request: Value) -> ExtensionResult<Vec<MangaChapter>> {
        ...
        Ok(manga::Madara::parse_chapters(&body, &key, &config)
            .into_iter()
            .filter(|chapter| !chapter.key.contains("/premium/"))
            .collect())
    }
...
fn config() -> MadaraConfig {
    MadaraConfig {
        base_url: "https://hentaixyuri.com",
        lang: "en",
...
<ul class="main version-chap"><li class="wp-manga-chapter"><a href="/manga/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">2024-01-01</span></li><li class="wp-manga-chapter premium"><a href="/manga/sample/premium/">Premium</a></li></ul>
"#;
