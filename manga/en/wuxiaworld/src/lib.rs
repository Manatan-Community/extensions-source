...
impl MangaSource for WuxiaWorld {
    ...
    fn details(&self, request: Value) -> ExtensionResult<CatalogItem> {
        let config = config();
        let key =
            manga::request_key(&request, "manga").unwrap_or_else(|| "/novel/sample".to_string());
        let body =
...
<div class="page-item-detail"><h3 class="post-title"><a href="/novel/sample/">Sample Novel</a></h3><img src="/cover.jpg"></div>
<div class="nav-previous"></div>
"#;
const DETAILS_FIXTURE: &str = r#"
<div class="post-title"><h1>Sample Novel</h1></div><div class="summary_image"><img src="/cover.jpg"></div>
<ul class="main version-chap"><li class="wp-manga-chapter"><a href="/novel/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">2024-01-01</span></li></ul>
"#;
...
mod tests {
    ...
    fn parses_madara_source() {
        ...
        assert_eq!(
            SOURCE
                .pages(json!({"chapter":"/novel/sample/chapter-1"}))
                .unwrap()
                .len(),
            1
        );
