...
const SOURCE: ComicHubFree = ComicHubFree;
const BASE_URL: &str = "https://comichubfree.com";

struct ComicHubFree;

impl MangaSource for ComicHubFree {
    fn list(&self, request: Value) -> ExtensionResult<Paged<CatalogItem>> {
        ...
        let target = format!("{BASE_URL}/{listing}?page={page}");
    ...
    fn search(&self, request: Value) -> ExtensionResult<Paged<CatalogItem>> {
        ...
        let target = format!(
            "{BASE_URL}/search-comic?key={}&page={page}",
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::attr_after(body, "property=\"og:title\"", "content")
            ...
            .unwrap_or_else(|| "ComicHubFree".to_string()),
