...
const SOURCE: MangaTX = MangaTX;
const BASE_URL: &str = "https://mangatx.cc";
const SOURCE_NAME: &str = "MangaTX";
const CONTENT_RATING: &str = "adult";
const MANGA_DIRECTORY: &str = "/manga-list";

struct MangaTX;

impl MangaSource for MangaTX {
...
fn search_url(
    ...
    let query = params
        ...
        .collect::<Vec<_>>()
        .join("&");
    format!("{BASE_URL}{MANGA_DIRECTORY}/?{query}")
}
...
const LIST_FIXTURE: &str = r#"<div class="listupd"><div class="bs"><div class="bsx"><a href="/manga/sample" title="Sample Crow"><img src="/cover.jpg"></a></div></div></div><div class="pagination"><a class="next"></a></div>"#;
const DETAILS_FIXTURE: &str = r#"<div class="bigcontent"><h1 class="entry-title">Sample Crow</h1><div class="thumb"><img src="/cover.jpg"></div><div class="desc">A sample.</div><div class="mgen"><a href="/genre/action">Action</a></div><div class="tsinfo"><div class="imptdt">Status <i>Ongoing</i></div></div><div id="chapterlist"><ul><li><div class="eph-num"><a href="/manga/sample/chapter-1"><span class="chapternum">Chapter 1</span><span class="chapterdate">2024-01-01</span></a></div></li></ul></div></div>"#;
...
mod tests {
    ...
    fn parses_themesia_source() {
        ...
        assert_eq!(listing.entries[0].title, "Sample Crow");
        let pages = SOURCE
