...
const SOURCE: ManhuaPlus = ManhuaPlus;

struct ManhuaPlus;

impl MangaSource for ManhuaPlus {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        ...
        let pages = parse_read_container_pages(&body, &config);
        if pages.is_empty() {
...
fn parse_read_container_pages(body: &str, config: &MadaraConfig) -> Vec<MangaPage> {
    body.split("<img")
        .skip(1)
        .filter_map(|chunk| {
...
<ul class="main version-chap"><li class="wp-manga-chapter"><a href="/manga/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">01 Ocak 2024</span></li></ul>
"#;
const PAGES_FIXTURE: &str = r#"<div class="read-container"><img src="/page1.jpg"></div>"#;
