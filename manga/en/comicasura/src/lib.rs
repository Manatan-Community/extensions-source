...
const SOURCE: ComicAsura = ComicAsura;
const BASE_URL: &str = "https://comicasura.net";

struct ComicAsura;

impl MangaSource for ComicAsura {
...
fn parse_details(body: &str, key: Option<String>) -> CatalogItem {
    ...
    CatalogItem {
        ...
        title: html::text_between(body, "<h1", "</h1>")
            ...
            .unwrap_or_else(|| "Comic Asura".to_string()),
...
const LIST_FIXTURE: &str = r#"<div class="grid"><a href="/manga/sample"><img title="Sample Asura" src="/cover.jpg"></a></div>"#;

const DETAILS_FIXTURE: &str = r#"
<h1>Sample Asura</h1><img alt="poster" src="/cover.jpg"><div class="comic-content mobile">A sample.</div>
...
mod tests {
    ...
    #[test]
    fn parses_themesia_shape() {
        let listing = SOURCE.list(json!({})).unwrap();
        assert_eq!(listing.entries[0].title, "Sample Asura");
        let pages = SOURCE
