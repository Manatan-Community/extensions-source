...
const SOURCE: ArtLapsa = ArtLapsa;
const BASE_URL: &str = "https://artlapsa.com";

struct ArtLapsa;

impl MangaSource for ArtLapsa {
...
<script type="application/ld+json">{"isPartOf":{"url":"https://artlapsa.com/series/sample"},"numberOfPages":2,"url":"https://artlapsa.com/series/sample/chapter-1"}</script>
"#;
