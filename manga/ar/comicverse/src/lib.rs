...
const SOURCE: ComicVerse = ComicVerse;
const BASE_URL: &str = "https://arcomixverse.blogspot.com";
const MANGA_CATEGORY: &str = "Series";
const CHAPTER_CATEGORY: &str = "Chapter";

struct ComicVerse;

impl MangaSource for ComicVerse {
...
const FEED_FIXTURE: &str = r#"{
  "feed": {"entry": [{"title":{"$t":"Sample Manga"},"category":[{"term":"Series"}],"link":[{"rel":"alternate","href":"https://arcomixverse.blogspot.com/2024/01/sample.html"}],"media$thumbnail":{"url":"https://img/cover.jpg"}}]}
}"#;

const CHAPTER_FEED_FIXTURE: &str = r#"{
  "feed": {"entry": [{"title":{"$t":"Chapter 1"},"published":{"$t":"2024-01-01T00:00:00.000Z"},"category":[{"term":"Chapter"}],"link":[{"rel":"alternate","href":"https://arcomixverse.blogspot.com/2024/01/chapter-1.html"}]}]}
}"#;
