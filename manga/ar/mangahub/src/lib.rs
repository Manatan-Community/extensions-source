...
const BASE_URL: &str = "https://www.mangaxhentai.com";
...
const FEED_FIXTURE: &str = r#"{
  "feed": {"entry": [{"title":{"$t":"Sample Manga"},"category":[{"term":"Series"}],"link":[{"rel":"alternate","href":"https://www.mangaxhentai.com/2024/01/sample.html"}],"media$thumbnail":{"url":"https://img/cover.jpg"}}]}
}"#;

const CHAPTER_FEED_FIXTURE: &str = r#"{
  "feed": {"entry": [{"title":{"$t":"Chapter 1"},"published":{"$t":"2024-01-01T00:00:00.000Z"},"category":[{"term":"Chapter"}],"link":[{"rel":"alternate","href":"https://www.mangaxhentai.com/2024/01/chapter-1.html"}]}]}
}"#;
