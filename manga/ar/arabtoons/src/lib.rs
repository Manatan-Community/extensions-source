...
const SOURCE: ArabToons = ArabToons;

struct ArabToons;

impl MangaSource for ArabToons {
...
<div class="post-title"><h1>Sample Manga</h1></div><div class="summary_image"><img src="/cover.jpg"><span class="status">مكتمل</span></div>
<div class="summary-text">Sample description.</div>
<div class="post-content_item"><h5>Genres</h5><div class="summary-content"><a>Drama</a></div></div>
