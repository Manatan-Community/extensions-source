...
const SOURCE: EmpireWebtoon = EmpireWebtoon;

struct EmpireWebtoon;

impl MangaSource for EmpireWebtoon {
    ...
    fn pages(&self, request: Value) -> ExtensionResult<Vec<MangaPage>> {
        ...
        let key = manga::request_key(&request, "chapter")
            .unwrap_or_else(|| "/webtoon/sample/chapter-1".to_string());
        let body =
...
fn config(request: &Value) -> MadaraConfig {
    let base_url = request
        ...
        .unwrap_or("https://webtoonempire-bl.com");
    MadaraConfig {
...
<div class="page-item-detail"><h3 class="post-title"><a href="/webtoon/sample/">Sample Manga</a></h3><img src="/cover.jpg"></div>
...
<ul class="main version-chap"><li class="wp-manga-chapter"><a href="/webtoon/sample/chapter-1/">Chapter 1</a><span class="chapter-release-date">01/01/2024</span></li></ul>
"#;
...
mod tests {
    ...
    fn parses_madara_source() {
        ...
        let chapters = SOURCE.chapters(json!({"manga":"/webtoon/sample"})).unwrap();
