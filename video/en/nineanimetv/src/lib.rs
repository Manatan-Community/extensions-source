...
const SOURCE: NineAnimeTv = NineAnimeTv;
const BASE_URL: &str = "https://9animetv.to";
const AJAX_ROUTE: &str = "";
const HOSTERS: [&str; 3] = ["DouVideo", "Vidstreaming", "Vidcloud"];
...
impl VideoSource for NineAnimeTv {
...
fn is_preferred(quality: &str, server: &str, media_type: &str, request: &Value) -> bool {
    ...
    let pref_server =
        preference(request, "preferred_server").unwrap_or_else(|| "DouVideo".to_string());
...
<div class="servers-sub"><div class="item" data-id="1" data-type="sub">DouVideo</div><div class="item" data-id="2" data-type="sub">Vidstreaming</div><div class="item" data-id="3" data-type="dub">Vidcloud</div></div>
"#;
