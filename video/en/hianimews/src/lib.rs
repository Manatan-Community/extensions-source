...
fn parse_card(chunk: &str, request: &Value) -> Option<CatalogItem> {
    let href = html::attr_after(chunk, "film-poster-ahref", "href")
...
const HOSTERS_FIXTURE: &str = r#"<div class="ps_-block ps_-block-softsub"><a class="server" data-lid="1">Server 1</a><a class="server" data-lid="2">Server 2</a></div>"#;
