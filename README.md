...
cargo run -p xtask -- build manga/en/lhtranslation
```

The command compiles and componentizes the guest, validates the component,
checks manifest permissions and asset digests, and writes a `.manatan2` package
under `dist/`.
